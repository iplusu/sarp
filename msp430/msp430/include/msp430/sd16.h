#ifndef __msp430_headers_sd16_h
#define __msp430_headers_sd16_h
 ...
 *
 * $Id: sd16.h,v 1.3 2004/06/15 13:50:15 coppice Exp $
 */
...
#define SD16LP              0x0100      /* AFE Low Power Mode Enable */
...
#define SD16OSR0            0x0100      /* AFE Channel x OverSampling Ratio 0 */
#define SD16OSR1            0x0200      /* AFE Channel x OverSampling Ratio 1 */
#define SD16SNGL            0x0400      /* SD16 Channel x Single Conversion On/Off */

#define SD16OSR_256         (0<<8)      /* AFE Channel x OverSampling Ratio 256 */
#define SD16OSR_128         (1<<8)      /* AFE Channel x OverSampling Ratio 128 */
#define SD16OSR_64          (2<<8)      /* AFE Channel x OverSampling Ratio  64 */
#define SD16OSR_32          (3<<8)      /* AFE Channel x OverSampling Ratio  32 */
...
#define AFECTL              SD16CTL     /* AFE Control Register */
