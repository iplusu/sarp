...
interface TransactionTable
{
   ...
   *    This command 
   */
  command void adjustThisNeighborsOverallTrust(Neighbor_Rec_withTrust_t neighbors[], uint16_t node_id, uint16_t numNeighbors);
   ...
   *    This command 
   */
   command uint16_t isALoop(Transaction_Record_t transactionRecords[], uint32_t transaction_id, uint16_t senderNow);
