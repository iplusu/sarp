  ...
  command void TransactionTable.adjustThisNeighborsOverallTrust(Neighbor_Rec_withTrust_t neighbors[], uint16_t node_id, uint16_t numNeighbors, uint16_t whoIAm, uint32_t transactionNumber, uint32_t GFBinc, uint32_t BFBinc, uint32_t GRBinc, uint32_t BRBinc, uint32_t GABinc, uint32_t BABinc, uint32_t GLBinc, uint32_t BLBinc)
  {
    ...
    for (tnLoopCounter = 0; tnLoopCounter < numNeighbors; tnLoopCounter ++)
    {
      if (neighbors[tnLoopCounter].node_id == node_id)
      {
        ...
        neighbors[tnLoopCounter].trust.GFB += GFBinc;
        neighbors[tnLoopCounter].trust.BFB += BFBinc;
		if(BFBinc != 0)	neighbors[tnLoopCounter].trust.trustFP = 0.1;
//        neighbors[tnLoopCounter].trust.trustFP = call Trust.calculateFP(neighbors[tnLoopCounter].trust.GFB, neighbors[tnLoopCounter].trust.BFB);
        ...
        neighbors[tnLoopCounter].trust.GRB += GRBinc;
        neighbors[tnLoopCounter].trust.BRB += BRBinc;
		if(BRBinc != 0)	neighbors[tnLoopCounter].trust.trustRH = 0.1;
//        neighbors[tnLoopCounter].trust.trustRH = call Trust.calculateRH(neighbors[tnLoopCounter].trust.GRB, neighbors[tnLoopCounter].trust.BRB);
        ...
        neighbors[tnLoopCounter].trust.GAB += GABinc;
        neighbors[tnLoopCounter].trust.BAB += BABinc;
		if(BABinc != 0)	neighbors[tnLoopCounter].trust.trustAV = 0.1;
//        neighbors[tnLoopCounter].trust.trustAV = call Trust.calculateAV(neighbors[tnLoopCounter].trust.GAB, neighbors[tnLoopCounter].trust.BAB);
        ...
        neighbors[tnLoopCounter].trust.GLB += GLBinc;
        neighbors[tnLoopCounter].trust.BLB += BLBinc;
		if(BLBinc != 0)	neighbors[tnLoopCounter].trust.trustLP = 0.1;
//        neighbors[tnLoopCounter].trust.trustLP = call Trust.calculateLP(neighbors[tnLoopCounter].trust.GLB, neighbors[tnLoopCounter].trust.BLB);
...
dbg(DBG_USR3, "%d\n", __LINE__);
  ...
  command void TransactionTable.doDynamicForgetting(Neighbor_Rec_withTrust_t neighbors[], uint16_t numNeighbors, uint16_t whoIAm)
  {
    for (tnLoopCounter = 0; tnLoopCounter < numNeighbors; tnLoopCounter ++)
    {
      ...
      neighbors[tnLoopCounter].trust.overallTrust = call Trust.calculateOverallTrust(neighbors[tnLoopCounter].trust.trustFP, neighbors[tnLoopCounter].trust.trustRH, neighbors[tnLoopCounter].trust.trustAV, neighbors[tnLoopCounter].trust.trustLP, neighbors[tnLoopCounter].trust.trustPR);
      */
      float forgetFP, forgetRH, forgetAV, forgetLP, forgetPR, temp;
	  forgetFP = 1 + call Trust.calculateFP(neighbors[tnLoopCounter].trust.GFB, neighbors[tnLoopCounter].trust.BFB);
	  forgetRH = 1 + call Trust.calculateRH(neighbors[tnLoopCounter].trust.GRB, neighbors[tnLoopCounter].trust.BRB);
	  forgetAV = 1 + call Trust.calculateAV(neighbors[tnLoopCounter].trust.GAB, neighbors[tnLoopCounter].trust.BAB);
	  forgetLP = 1 + call Trust.calculateLP(neighbors[tnLoopCounter].trust.GLB, neighbors[tnLoopCounter].trust.BLB);
	  forgetPR = 1 + call Trust.calculatePR(neighbors[tnLoopCounter].trust.GPB, neighbors[tnLoopCounter].trust.BPB);
      ...
      neighbors[tnLoopCounter].trust.overallTrust = call Trust.calculateOverallTrust(neighbors[tnLoopCounter].trust.trustFP, neighbors[tnLoopCounter].trust.trustRH, neighbors[tnLoopCounter].trust.trustAV, neighbors[tnLoopCounter].trust.trustLP, neighbors[tnLoopCounter].trust.trustPR);
#ifdef TRUSTVALUES
	  dbg(DBG_USR3, "[%d] GFB:%d BFB:%d FP-forget:%f trust:%f\n", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.GFB, neighbors[tnLoopCounter].trust.BFB, forgetFP, neighbors[tnLoopCounter].trust.trustFP);
	  dbg(DBG_USR3, "[%d] GRB:%d BRB:%d RH-forget:%f trust:%f\n", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.GRB, neighbors[tnLoopCounter].trust.BRB, forgetRH, neighbors[tnLoopCounter].trust.trustRH);
	  dbg(DBG_USR3, "[%d] GAB:%d BAB:%d AV-forget:%f trust:%f\n", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.GAB, neighbors[tnLoopCounter].trust.BAB, forgetAV, neighbors[tnLoopCounter].trust.trustAV);
	  dbg(DBG_USR3, "[%d] GLB:%d BLB:%d LP-forget:%f trust:%f\n", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.GLB, neighbors[tnLoopCounter].trust.BLB, forgetLP, neighbors[tnLoopCounter].trust.trustLP);
	  dbg(DBG_USR3, "[%d] GPB:%d BPB:%d PR-forget:%f trust:%f\n", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.GPB, neighbors[tnLoopCounter].trust.BPB, forgetPR, neighbors[tnLoopCounter].trust.trustPR);
