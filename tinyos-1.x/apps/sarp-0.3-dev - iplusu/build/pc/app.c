...
# 22 "/opt/tinyos-1.x/apps/sarp-0.3-dev/includes/MessagingH.h"
...
# 13 "/opt/tinyos-1.x/apps/sarp-0.3-dev/includes/Globals.h"
...
# 40 "/opt/tinyos-1.x/apps/sarp-0.3-dev/includes/NeighborTableH.h"
...
# 13 "/opt/tinyos-1.x/apps/sarp-0.3-dev/includes/TransactionTableH.h"
...
int8_t tIndex;
# 7 "/opt/tinyos-1.x/apps/sarp-0.3-dev/includes/TrustH.h"
...
# 16 "/opt/tinyos-1.x/apps/sarp-0.3-dev/includes/AttackH.h"
uint16_t aCounter;
...
# 7 "/opt/tinyos-1.x/apps/sarp-0.3-dev/includes/TrafficGeneratorH.h"
uint16_t tfLoopCounter;
uint16_t trafficGenerators[1] = { 4 };
uint16_t numTrafficGenerators = 1;
static  result_t Nido$RadioSendMsg$default$sendDone(TOS_MsgPtr arg_0x898ba90, result_t arg_0x898bbe0);
...
static   result_t PowerStateM$PowerState$init(int arg_0x8988a80, int arg_0x8988bc8);
...
static   double PowerStateM$PowerState$get_mote_cycles(int arg_0x8988670);
...
static  result_t TimerM$Timer$default$fired(uint8_t arg_0x8a26758);
static  result_t TimerM$Timer$start(uint8_t arg_0x8a26758, char arg_0x8a54f78, uint32_t arg_0x8a550d0);
static  result_t TimerM$Timer$stop(uint8_t arg_0x8a26758);
static   void HPLClock$Clock$setInterval(uint8_t arg_0x8a417b8);
static   uint8_t HPLClock$Clock$readCounter(void);
static   result_t HPLClock$Clock$setRate(char arg_0x8a40cb8, char arg_0x8a40df8);
static   uint8_t HPLClock$Clock$getInterval(void);
static   uint8_t HPLPowerManagementM$PowerManagement$adjustPower(void);
static  result_t SimpleTimeM$AbsoluteTimer$default$fired(uint8_t arg_0x8a9fc90);
static  result_t SimpleTimeM$Timer$fired(void);
static   tos_time_t TimeUtilC$TimeUtil$addUint32(tos_time_t arg_0x8a39480, uint32_t arg_0x8a395d0);
static   char TimeUtilC$TimeUtil$compare(tos_time_t arg_0x8a32200, tos_time_t arg_0x8a32350);
static  result_t SarpM$SendDisc$sendDone(TOS_MsgPtr arg_0x8ace718, result_t arg_0x8ace868);
static  result_t SarpM$SendReportNoForwardResponse$sendDone(TOS_MsgPtr arg_0x8ace718, result_t arg_0x8ace868);
static  result_t SarpM$SendReportForwardResponse$sendDone(TOS_MsgPtr arg_0x8ace718, result_t arg_0x8ace868);
static  result_t SarpM$SendReportRequest$sendDone(TOS_MsgPtr arg_0x8ace718, result_t arg_0x8ace868);
static  result_t SarpM$SendUDisc$sendDone(TOS_MsgPtr arg_0x8ace718, result_t arg_0x8ace868);
static  result_t SarpM$Timer6$fired(void);
static  result_t SarpM$Timer9$fired(void);
static  result_t SarpM$Timer1$fired(void);
static  result_t SarpM$SendSpecificReportRequest$sendDone(TOS_MsgPtr arg_0x8ace718, result_t arg_0x8ace868);
static  result_t SarpM$SendSpecificReportResponse$sendDone(TOS_MsgPtr arg_0x8ace718, result_t arg_0x8ace868);
static  TOS_MsgPtr SarpM$Receive$receive(TOS_MsgPtr arg_0x898dda8);
static  result_t SarpM$Timer4$fired(void);
static  result_t SarpM$SendStart$sendDone(TOS_MsgPtr arg_0x8ace718, result_t arg_0x8ace868);
static  result_t SarpM$Timer7$fired(void);
static  result_t SarpM$Timer10$fired(void);
static  result_t SarpM$SendReport$sendDone(TOS_MsgPtr arg_0x8ace718, result_t arg_0x8ace868);
static  result_t SarpM$Timer2$fired(void);
static  result_t SarpM$SendEndToEndReportResponse$sendDone(TOS_MsgPtr arg_0x8ace718, result_t arg_0x8ace868);
...
static  result_t SarpM$SendData$sendDone(TOS_MsgPtr arg_0x8ace718, result_t arg_0x8ace868);
static  TOS_MsgPtr AMStandard$ReceiveMsg$default$receive(uint8_t arg_0x8b9ea00, TOS_MsgPtr arg_0x898dda8);
static  result_t AMStandard$ActivityTimer$fired(void);
static  result_t AMStandard$UARTSend$sendDone(TOS_MsgPtr arg_0x898ba90, result_t arg_0x898bbe0);
static  TOS_MsgPtr AMStandard$RadioReceive$receive(TOS_MsgPtr arg_0x898dda8);
...
static  result_t AMStandard$RadioSend$sendDone(TOS_MsgPtr arg_0x898ba90, result_t arg_0x898bbe0);
static  result_t AMStandard$SendMsg$send(uint8_t arg_0x8b9e448, uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8);
static  result_t AMStandard$SendMsg$default$sendDone(uint8_t arg_0x8b9e448, TOS_MsgPtr arg_0x8ace718, result_t arg_0x8ace868);
static  TOS_MsgPtr AMStandard$UARTReceive$receive(TOS_MsgPtr arg_0x898dda8);
static  result_t MicaHighSpeedRadioM$Send$send(TOS_MsgPtr arg_0x898b578);
static  result_t MicaHighSpeedRadioM$Code$decodeDone(char arg_0x8bb65d8, char arg_0x8bb6718);
static  result_t MicaHighSpeedRadioM$Code$encodeDone(char arg_0x8bb6b20);
static   void MicaHighSpeedRadioM$RadioReceiveCoordinator$default$byte(TOS_MsgPtr arg_0x8bbdd78, uint8_t arg_0x8bbdec8);
static   void MicaHighSpeedRadioM$RadioReceiveCoordinator$default$startSymbol(uint8_t arg_0x8bbd668, uint8_t arg_0x8bbd7b0, TOS_MsgPtr arg_0x8bbd900);
static  result_t MicaHighSpeedRadioM$SpiByteFifo$dataReady(uint8_t arg_0x8bb0978);
...
static   void MicaHighSpeedRadioM$RadioSendCoordinator$default$byte(TOS_MsgPtr arg_0x8bbdd78, uint8_t arg_0x8bbdec8);
static   void MicaHighSpeedRadioM$RadioSendCoordinator$default$startSymbol(uint8_t arg_0x8bbd668, uint8_t arg_0x8bbd7b0, TOS_MsgPtr arg_0x8bbd900);
...
static  result_t SecDedEncoding$Code$decode(char arg_0x8bb61d8);
static  result_t SecDedEncoding$Code$encode(char arg_0x8bb9db8);
...
static  result_t SpiByteFifoC$SpiByteFifo$send(uint8_t arg_0x8bb5648);
static  result_t SpiByteFifoC$SpiByteFifo$phaseShift(void);
static  result_t SpiByteFifoC$SpiByteFifo$startReadBytes(uint16_t arg_0x8bb5d08);
...
static  TOS_MsgPtr CrcFilter$LowerReceive$receive(TOS_MsgPtr arg_0x898dda8);
static  result_t UARTNoCRCPacketM$Send$send(TOS_MsgPtr arg_0x898b578);
...
static  result_t PacketSink$Send$send(TOS_MsgPtr arg_0x898b578);
...
static  float TrustM$Trust$calculateLP(uint32_t arg_0x8aef118, uint32_t arg_0x8aef268);
static  float TrustM$Trust$calculateAV(uint32_t arg_0x8aeebc0, uint32_t arg_0x8aeed10);
static  float TrustM$Trust$calculateRH(uint32_t arg_0x8aee668, uint32_t arg_0x8aee7b8);
static  float TrustM$Trust$calculateOverallTrust(float arg_0x8aefbc0, float arg_0x8aefd00, float arg_0x8aefe40, float arg_0x8aec010, float arg_0x8aec150);
static  float TrustM$Trust$calculatePR(uint32_t arg_0x8aef670, uint32_t arg_0x8aef7c0);
static  float TrustM$Trust$calculateFP(uint32_t arg_0x8aee110, uint32_t arg_0x8aee260);
static  uint16_t TrustM$Trust$areReportsConsistent(uint16_t arg_0x8aec598, uint16_t arg_0x8aec6f8);
static  uint16_t NeighborTableM$NeighborTable$getNewTransactionParent(Neighbor_Rec_withTrust_t *arg_0x8ac9860[], uint16_t arg_0x8ac99c0, uint8_t arg_0x8ac9b10, Neighbor_Rec_withTrust_t *arg_0x8ac9ca8[], uint16_t arg_0x8ac9e00, Neighbor_Rec_withTrust_t *arg_0x8ac6010[], uint16_t arg_0x8ac6168, uint16_t arg_0x8ac62c0, uint16_t arg_0x8ac6420, uint16_t arg_0x8ac6580, uint16_t arg_0x8ac66d0);
static  result_t NeighborTableM$NeighborTable$processNeighborFromDiscMsg(Neighbor_Rec_withTrust_t arg_0x8ac8260[], Neighbor_Rec_withTrust_t *arg_0x8ac8408[], uint16_t *arg_0x8ac8578, uint16_t *arg_0x8ac86f0, uint16_t arg_0x8ac8848, uint8_t arg_0x8ac8990, uint16_t arg_0x8ac8af0, uint16_t *arg_0x8ac8c60);
static  result_t NeighborTableM$NeighborTable$addNeighborsToDiscMsg(Disc_Rec_t arg_0x8ac90d8[], uint16_t arg_0x8ac9238, Neighbor_Rec_withTrust_t *arg_0x8ac93e0[]);
...
static  uint16_t TransactionTableM$TransactionTable$isALoop(Transaction_Record_t arg_0x8af39d0[], uint32_t arg_0x8af3b28, uint16_t arg_0x8af3c80, uint16_t arg_0x8af3de0);
static  void TransactionTableM$TransactionTable$adjustThisNeighborsOverallTrust(Neighbor_Rec_withTrust_t arg_0x8ac36c8[], uint16_t arg_0x8ac3818, uint16_t arg_0x8ac3970, uint16_t arg_0x8ac3ac0, uint32_t arg_0x8ac3c20, uint32_t arg_0x8ac3d70, uint32_t arg_0x8ac3ec0, uint32_t arg_0x8af4030, uint32_t arg_0x8af4180, uint32_t arg_0x8af42d0, uint32_t arg_0x8af4420, uint32_t arg_0x8af4570, uint32_t arg_0x8af46c0);
static  uint8_t TransactionTableM$TransactionTable$transactionExistsAlready(Transaction_Record_t arg_0x8ac5228[], uint32_t arg_0x8ac5380, uint16_t arg_0x8ac54d0);
static  void TransactionTableM$TransactionTable$addToTransactionCheckQ(Check_Transaction_Record_t arg_0x8af4bd8[], Transaction_Record_Ptr arg_0x8af4d30, uint16_t arg_0x8af4e80, uint16_t arg_0x8af4fd0, uint16_t *arg_0x8af5140, uint16_t arg_0x8af5298, uint16_t *arg_0x8af5408);
static  uint16_t TransactionTableM$TransactionTable$getTransactionParent(Transaction_Record_t arg_0x8ac2d10[], uint32_t arg_0x8ac2e68);
static  void TransactionTableM$TransactionTable$incrementSequenceNumber(Transaction_Record_t arg_0x8ac5920[], uint32_t arg_0x8ac5a78);
static  Transaction_Record_Ptr TransactionTableM$TransactionTable$getThisTransactionPtr(Transaction_Record_t arg_0x8ac5ed0[], uint32_t arg_0x8ac2060);
static  result_t TransactionTableM$TransactionTable$initializeTransaction(Transaction_Record_t arg_0x8ac7b90[], uint32_t arg_0x8ac7ce8, uint16_t arg_0x8ac7e40, uint16_t arg_0x8ac4010, Neighbor_Rec_withTrust_t *arg_0x8ac41b8[], uint16_t arg_0x8ac4318, uint16_t arg_0x8ac4468, uint16_t arg_0x8ac45c0, Neighbor_Rec_withTrust_t *arg_0x8ac4758[], uint16_t arg_0x8ac48b0, Neighbor_Rec_withTrust_t *arg_0x8ac4a50[], uint16_t arg_0x8ac4ba8, uint16_t arg_0x8ac4cf8);
static  void TransactionTableM$TransactionTable$markAsLoop(Transaction_Record_Ptr arg_0x8ac3280);
static  uint16_t TransactionTableM$TransactionTable$sendReportRequestForThisTransaction(Transaction_Record_t arg_0x8af2d18[], uint32_t arg_0x8af2e70, TOS_Msg arg_0x8af2fd8[], uint16_t *arg_0x8af3148, uint16_t arg_0x8af32a0, uint16_t *arg_0x8af3410, uint16_t arg_0x8af3560);
static  uint16_t TransactionTableM$TransactionTable$getFromTransactionCheckQ(Check_Transaction_Record_t arg_0x8af5888[], Transaction_Record_Ptr *arg_0x8af59f8, uint16_t *arg_0x8af5b60, uint16_t *arg_0x8af5cc8, uint16_t *arg_0x8af5e38, uint16_t arg_0x8af2010, uint16_t *arg_0x8af2180);
static  void TransactionTableM$TransactionTable$doDynamicForgetting(Neighbor_Rec_withTrust_t arg_0x8af02f8[], uint16_t arg_0x8af0450, uint16_t arg_0x8af05a0);
static  void TransactionTableM$TransactionTable$setOriginatorPacketCount(Transaction_Record_t arg_0x8af25f8[], uint32_t arg_0x8af2750, uint16_t arg_0x8af28a8);
static  void TransactionTableM$TransactionTable$processThisTransaction(Transaction_Record_Ptr arg_0x8ac2480, Neighbor_Rec_withTrust_t arg_0x8ac2608[], uint16_t arg_0x8ac2760, uint16_t arg_0x8ac28b0);
static  void MessagingM$Messaging$putReportResponseNoForwardMsgInOutQ(TOS_Msg arg_0x8ae7700[], uint16_t *arg_0x8ae7870, uint16_t arg_0x8ae79c8, uint16_t *arg_0x8ae7b38, uint16_t arg_0x8ae7c90, uint32_t arg_0x8ae7de8, uint16_t arg_0x8ae7f40, uint16_t arg_0x8ae40b0, uint16_t arg_0x8ae4210, uint16_t arg_0x8ae4370, uint16_t arg_0x8ae44c8);
static  void MessagingM$Messaging$putStartMsgInOutQ(TOS_Msg arg_0x8ae2b38[], uint16_t *arg_0x8ae2ca8, uint16_t arg_0x8ae2e00, uint16_t *arg_0x8ae2f70, uint16_t arg_0x8ae30c0);
static  void MessagingM$Messaging$putSpecificReportResponseMsgInOutQ(TOS_Msg arg_0x8ae6360[], uint16_t *arg_0x8ae64d0, uint16_t arg_0x8ae6628, uint16_t *arg_0x8ae6798, uint16_t arg_0x8ae68f0, uint16_t arg_0x8ae6a48, uint32_t arg_0x8ae6ba0, uint16_t arg_0x8ae6cf8, uint16_t arg_0x8ae6e58, uint16_t arg_0x8ae6fb8, uint16_t arg_0x8ae7118, uint16_t arg_0x8ae7278);
static  void MessagingM$Messaging$putSpecificReportRequestMsgInOutQ(TOS_Msg arg_0x8b17278[], uint16_t *arg_0x8b173e8, uint16_t arg_0x8b17540, uint16_t *arg_0x8b176b0, uint16_t arg_0x8b17810, uint16_t arg_0x8b17968, uint16_t arg_0x8b17ac0, uint16_t arg_0x8b17c18, uint16_t arg_0x8b17d78, uint32_t arg_0x8b17ed0);
static  void MessagingM$Messaging$putDiscoveryMsgInOutQ(TOS_Msg arg_0x8aeb2e8[], uint16_t *arg_0x8aeb458, uint16_t arg_0x8aeb5b0, uint16_t *arg_0x8aeb720, uint16_t arg_0x8aeb870, uint16_t arg_0x8aeb9c0, uint16_t arg_0x8aebb18, uint16_t arg_0x8aebc78, Neighbor_Rec_withTrust_t *arg_0x8aebe20[]);
static  void MessagingM$Messaging$putNeighborDiscoveryControlMsgInOutQ(TOS_Msg arg_0x8ae3510[], uint16_t *arg_0x8ae3680, uint16_t arg_0x8ae37d8, uint16_t *arg_0x8ae3948, uint16_t arg_0x8ae3a98, uint16_t arg_0x8ae3bf0, uint16_t arg_0x8ae3d40);
static  void MessagingM$Messaging$putDataMessageInOutQ(TOS_Msg arg_0x8aedd68[], uint16_t *arg_0x8aeded8, uint16_t arg_0x8aea060, uint16_t *arg_0x8aea1d0, uint16_t arg_0x8aea328, uint16_t arg_0x8aea480, uint32_t arg_0x8aea5d8, uint16_t arg_0x8aea730, uint16_t arg_0x8aea880, uint16_t arg_0x8aea9d8, uint16_t arg_0x8aeab30, uint16_t arg_0x8aeac88, uint16_t arg_0x8aeade8);
static  void MessagingM$Messaging$putReportRequestMsgInOutQ(TOS_Msg arg_0x8b16310[], uint16_t *arg_0x8b16480, uint16_t arg_0x8b165d8, uint16_t *arg_0x8b16748, uint16_t arg_0x8b168a0, uint16_t arg_0x8b169f8, uint16_t arg_0x8b16b50, uint16_t arg_0x8b16cb0, uint32_t arg_0x8b16e08);
static  void MessagingM$Messaging$putEndToEndReportResponseMsgInOutQ(TOS_Msg arg_0x8ae5a20[], uint16_t *arg_0x8ae5b90, uint16_t arg_0x8ae5ce8, uint16_t *arg_0x8ae5e58, uint16_t arg_0x8ae2010, uint16_t arg_0x8ae2168, uint32_t arg_0x8ae22c0, uint16_t arg_0x8ae2418, uint16_t arg_0x8ae2578, uint16_t arg_0x8ae26d0);
static  uint16_t AttackM$Attack$sfDropThis(uint16_t arg_0x8acd610, uint16_t arg_0x8acd768, uint16_t *arg_0x8acd8e0);
static  uint16_t AttackM$Attack$ifLoopCreatorGetParent(uint16_t arg_0x8acdd10);
static  uint16_t AttackM$Attack$getNumThirtySeconds(uint16_t arg_0x8adedb8);
static  uint16_t AttackM$Attack$isNoResponder(uint16_t arg_0x8ade580);
static  uint16_t AttackM$Attack$isOnOffAttacker(uint16_t arg_0x8ade998);
static  uint16_t AttackM$Attack$isLoopCreator(uint16_t arg_0x8ade168);
static  float TrafficGeneratorM$TrafficGenerator$isTrafficGenerator(uint16_t arg_0x8b14408);
static  
# 75 "/opt/tinyos-1.x/tos/interfaces/ReceiveMsg.nc"
TOS_MsgPtr Nido$UARTReceiveMsg$receive(TOS_MsgPtr arg_0x898dda8);
static   
# 22 "/opt/tinyos-1.x/tos/platform/pc/PowerState.nc"
void Nido$PowerState$CPUCycleCheckpoint(void);
static   
#line 14
result_t Nido$PowerState$init(int arg_0x8988a80, int arg_0x8988bc8);
static   
...
result_t Nido$RadioSendMsg$sendDone(TOS_MsgPtr arg_0x898ba90, result_t arg_0x898bbe0);
static  
# 75 "/opt/tinyos-1.x/tos/interfaces/ReceiveMsg.nc"
TOS_MsgPtr Nido$RadioReceiveMsg$receive(TOS_MsgPtr arg_0x898dda8);
static  
...
void TimerM$Clock$setInterval(uint8_t arg_0x8a417b8);
static   
#line 153
uint8_t TimerM$Clock$readCounter(void);
static   
#line 96
result_t TimerM$Clock$setRate(char arg_0x8a40cb8, char arg_0x8a40df8);
static   
#line 121
...
uint8_t arg_0x8a9fc90);
static   
# 65 "/opt/tinyos-1.x/tos/interfaces/TimeUtil.nc"
tos_time_t SimpleTimeM$TimeUtil$addUint32(tos_time_t arg_0x8a39480, uint32_t arg_0x8a395d0);
static   
#line 82
char SimpleTimeM$TimeUtil$compare(tos_time_t arg_0x8a32200, tos_time_t arg_0x8a32350);
# 65 "/opt/tinyos-1.x/tos/system/SimpleTimeM.nc"
enum SimpleTimeM$__nesc_unnamed4355 {
...
result_t SarpM$SendDisc$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8);
static  
#line 48
result_t SarpM$SendReportNoForwardResponse$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8);
static  
#line 48
result_t SarpM$SendReportForwardResponse$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8);
static  
# 39 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/Messaging.nc"
void SarpM$Messaging$putReportResponseNoForwardMsgInOutQ(TOS_Msg arg_0x8ae7700[], uint16_t *arg_0x8ae7870, uint16_t arg_0x8ae79c8, uint16_t *arg_0x8ae7b38, uint16_t arg_0x8ae7c90, uint32_t arg_0x8ae7de8, uint16_t arg_0x8ae7f40, uint16_t arg_0x8ae40b0, uint16_t arg_0x8ae4210, uint16_t arg_0x8ae4370, uint16_t arg_0x8ae44c8);
static  
#line 54
void SarpM$Messaging$putStartMsgInOutQ(TOS_Msg arg_0x8ae2b38[], uint16_t *arg_0x8ae2ca8, uint16_t arg_0x8ae2e00, uint16_t *arg_0x8ae2f70, uint16_t arg_0x8ae30c0);
static  
#line 34
void SarpM$Messaging$putSpecificReportResponseMsgInOutQ(TOS_Msg arg_0x8ae6360[], uint16_t *arg_0x8ae64d0, uint16_t arg_0x8ae6628, uint16_t *arg_0x8ae6798, uint16_t arg_0x8ae68f0, uint16_t arg_0x8ae6a48, uint32_t arg_0x8ae6ba0, uint16_t arg_0x8ae6cf8, uint16_t arg_0x8ae6e58, uint16_t arg_0x8ae6fb8, uint16_t arg_0x8ae7118, uint16_t arg_0x8ae7278);
static  
#line 29
void SarpM$Messaging$putSpecificReportRequestMsgInOutQ(TOS_Msg arg_0x8b17278[], uint16_t *arg_0x8b173e8, uint16_t arg_0x8b17540, uint16_t *arg_0x8b176b0, uint16_t arg_0x8b17810, uint16_t arg_0x8b17968, uint16_t arg_0x8b17ac0, uint16_t arg_0x8b17c18, uint16_t arg_0x8b17d78, uint32_t arg_0x8b17ed0);
static  
#line 19
void SarpM$Messaging$putDiscoveryMsgInOutQ(TOS_Msg arg_0x8aeb2e8[], uint16_t *arg_0x8aeb458, uint16_t arg_0x8aeb5b0, uint16_t *arg_0x8aeb720, uint16_t arg_0x8aeb870, uint16_t arg_0x8aeb9c0, uint16_t arg_0x8aebb18, uint16_t arg_0x8aebc78, Neighbor_Rec_withTrust_t *arg_0x8aebe20[]);
static  
#line 60
void SarpM$Messaging$putNeighborDiscoveryControlMsgInOutQ(TOS_Msg arg_0x8ae3510[], uint16_t *arg_0x8ae3680, uint16_t arg_0x8ae37d8, uint16_t *arg_0x8ae3948, uint16_t arg_0x8ae3a98, uint16_t arg_0x8ae3bf0, uint16_t arg_0x8ae3d40);
static  
#line 14
void SarpM$Messaging$putDataMessageInOutQ(TOS_Msg arg_0x8aedd68[], uint16_t *arg_0x8aeded8, uint16_t arg_0x8aea060, uint16_t *arg_0x8aea1d0, uint16_t arg_0x8aea328, uint16_t arg_0x8aea480, uint32_t arg_0x8aea5d8, uint16_t arg_0x8aea730, uint16_t arg_0x8aea880, uint16_t arg_0x8aea9d8, uint16_t arg_0x8aeab30, uint16_t arg_0x8aeac88, uint16_t arg_0x8aeade8);
static  
...
void SarpM$Messaging$putReportRequestMsgInOutQ(TOS_Msg arg_0x8b16310[], uint16_t *arg_0x8b16480, uint16_t arg_0x8b165d8, uint16_t *arg_0x8b16748, uint16_t arg_0x8b168a0, uint16_t arg_0x8b169f8, uint16_t arg_0x8b16b50, uint16_t arg_0x8b16cb0, uint32_t arg_0x8b16e08);
static  
#line 49
void SarpM$Messaging$putEndToEndReportResponseMsgInOutQ(TOS_Msg arg_0x8ae5a20[], uint16_t *arg_0x8ae5b90, uint16_t arg_0x8ae5ce8, uint16_t *arg_0x8ae5e58, uint16_t arg_0x8ae2010, uint16_t arg_0x8ae2168, uint32_t arg_0x8ae22c0, uint16_t arg_0x8ae2418, uint16_t arg_0x8ae2578, uint16_t arg_0x8ae26d0);
static  
# 48 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
result_t SarpM$SendReportRequest$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8);
static  
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
result_t SarpM$Timer6$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0);
static  
# 10 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/Attack.nc"
uint16_t SarpM$Attack$sfDropThis(uint16_t arg_0x8acd610, uint16_t arg_0x8acd768, uint16_t *arg_0x8acd8e0);
static  
#line 45
uint16_t SarpM$Attack$getNumThirtySeconds(uint16_t arg_0x8adedb8);
static  
#line 34
uint16_t SarpM$Attack$isNoResponder(uint16_t arg_0x8ade580);
static  
...
uint16_t SarpM$Attack$isOnOffAttacker(uint16_t arg_0x8ade998);
static  
#line 26
uint16_t SarpM$Attack$isLoopCreator(uint16_t arg_0x8ade168);
static  
# 12 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/TrafficGenerator.nc"
float SarpM$TrafficGenerator$isTrafficGenerator(uint16_t arg_0x8b14408);
static  
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
result_t SarpM$Timer9$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0);
static  
#line 59
result_t SarpM$Timer1$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0);
static  
...
static  
# 48 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
result_t SarpM$SendSpecificReportRequest$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8);
static  
#line 48
result_t SarpM$SendSpecificReportResponse$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8);
static  
# 63 "/opt/tinyos-1.x/tos/interfaces/StdControl.nc"
...
static  
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
result_t SarpM$Timer4$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0);
static  
# 48 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
result_t SarpM$SendStart$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8);
static  
# 63 "/opt/tinyos-1.x/tos/interfaces/StdControl.nc"
...
static  
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
result_t SarpM$Timer7$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0);
static  
#line 59
result_t SarpM$Timer10$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0);
static   
...
static  
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
result_t SarpM$Timer2$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0);
static  
# 17 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/NeighborTable.nc"
result_t SarpM$NeighborTable$processNeighborFromDiscMsg(Neighbor_Rec_withTrust_t arg_0x8ac8260[], Neighbor_Rec_withTrust_t *arg_0x8ac8408[], uint16_t *arg_0x8ac8578, uint16_t *arg_0x8ac86f0, uint16_t arg_0x8ac8848, uint8_t arg_0x8ac8990, uint16_t arg_0x8ac8af0, uint16_t *arg_0x8ac8c60);
static  
# 97 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/TransactionTable.nc"
uint16_t SarpM$TransactionTable$isALoop(Transaction_Record_t arg_0x8af39d0[], uint32_t arg_0x8af3b28, uint16_t arg_0x8af3c80, uint16_t arg_0x8af3de0);
static  
#line 22
uint8_t SarpM$TransactionTable$transactionExistsAlready(Transaction_Record_t arg_0x8ac5228[], uint32_t arg_0x8ac5380, uint16_t arg_0x8ac54d0);
static  
#line 77
void SarpM$TransactionTable$addToTransactionCheckQ(Check_Transaction_Record_t arg_0x8af4bd8[], Transaction_Record_Ptr arg_0x8af4d30, uint16_t arg_0x8af4e80, uint16_t arg_0x8af4fd0, uint16_t *arg_0x8af5140, uint16_t arg_0x8af5298, uint16_t *arg_0x8af5408);
static  
#line 42
uint16_t SarpM$TransactionTable$getTransactionParent(Transaction_Record_t arg_0x8ac2d10[], uint32_t arg_0x8ac2e68);
static  
#line 27
void SarpM$TransactionTable$incrementSequenceNumber(Transaction_Record_t arg_0x8ac5920[], uint32_t arg_0x8ac5a78);
static  



Transaction_Record_Ptr SarpM$TransactionTable$getThisTransactionPtr(Transaction_Record_t arg_0x8ac5ed0[], uint32_t arg_0x8ac2060);
static  
#line 16
result_t SarpM$TransactionTable$initializeTransaction(Transaction_Record_t arg_0x8ac7b90[], uint32_t arg_0x8ac7ce8, uint16_t arg_0x8ac7e40, uint16_t arg_0x8ac4010, Neighbor_Rec_withTrust_t *arg_0x8ac41b8[], uint16_t arg_0x8ac4318, uint16_t arg_0x8ac4468, uint16_t arg_0x8ac45c0, Neighbor_Rec_withTrust_t *arg_0x8ac4758[], uint16_t arg_0x8ac48b0, Neighbor_Rec_withTrust_t *arg_0x8ac4a50[], uint16_t arg_0x8ac4ba8, uint16_t arg_0x8ac4cf8);
static  
#line 67
void SarpM$TransactionTable$markAsLoop(Transaction_Record_Ptr arg_0x8ac3280);
static  
#line 92
uint16_t SarpM$TransactionTable$sendReportRequestForThisTransaction(Transaction_Record_t arg_0x8af2d18[], uint32_t arg_0x8af2e70, TOS_Msg arg_0x8af2fd8[], uint16_t *arg_0x8af3148, uint16_t arg_0x8af32a0, uint16_t *arg_0x8af3410, uint16_t arg_0x8af3560);
static  
#line 82
uint16_t SarpM$TransactionTable$getFromTransactionCheckQ(Check_Transaction_Record_t arg_0x8af5888[], Transaction_Record_Ptr *arg_0x8af59f8, uint16_t *arg_0x8af5b60, uint16_t *arg_0x8af5cc8, uint16_t *arg_0x8af5e38, uint16_t arg_0x8af2010, uint16_t *arg_0x8af2180);
static  
#line 102
void SarpM$TransactionTable$doDynamicForgetting(Neighbor_Rec_withTrust_t arg_0x8af02f8[], uint16_t arg_0x8af0450, uint16_t arg_0x8af05a0);
static  
#line 87
void SarpM$TransactionTable$setOriginatorPacketCount(Transaction_Record_t arg_0x8af25f8[], uint32_t arg_0x8af2750, uint16_t arg_0x8af28a8);
static  
#line 37
void SarpM$TransactionTable$processThisTransaction(Transaction_Record_Ptr arg_0x8ac2480, Neighbor_Rec_withTrust_t arg_0x8ac2608[], uint16_t arg_0x8ac2760, uint16_t arg_0x8ac28b0);
static  
# 48 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
result_t SarpM$SendEndToEndReportResponse$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8);
static  
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
result_t SarpM$Timer8$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0);
static  
# 48 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
result_t SarpM$SendData$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8);
# 83 "SarpM.nc"
...
Neighbor_Rec_withTrust_t *SarpM$myChildren[1000][32];
#line 149
Neighbor_Rec_withTrust_t *SarpM$myPeers[1000][32];
...
uint8_t arg_0x8b9ea00, 
# 75 "/opt/tinyos-1.x/tos/interfaces/ReceiveMsg.nc"
TOS_MsgPtr arg_0x898dda8);
static  
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
result_t AMStandard$ActivityTimer$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0);
static  
...
result_t AMStandard$UARTSend$send(TOS_MsgPtr arg_0x898b578);
static   
# 41 "/opt/tinyos-1.x/tos/interfaces/PowerManagement.nc"
...
static  
# 58 "/opt/tinyos-1.x/tos/interfaces/BareSendMsg.nc"
result_t AMStandard$RadioSend$send(TOS_MsgPtr arg_0x898b578);
static  
...
uint8_t arg_0x8b9e448, 
# 49 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
TOS_MsgPtr arg_0x8ace718, result_t arg_0x8ace868);
...
static  
# 67 "/opt/tinyos-1.x/tos/interfaces/BareSendMsg.nc"
result_t MicaHighSpeedRadioM$Send$sendDone(TOS_MsgPtr arg_0x898ba90, result_t arg_0x898bbe0);
static   
...
static  
result_t MicaHighSpeedRadioM$Code$decode(char arg_0x8bb61d8);
static  
#line 34
result_t MicaHighSpeedRadioM$Code$encode(char arg_0x8bb9db8);
static  
# 75 "/opt/tinyos-1.x/tos/interfaces/ReceiveMsg.nc"
TOS_MsgPtr MicaHighSpeedRadioM$Receive$receive(TOS_MsgPtr arg_0x898dda8);
static   
# 38 "/opt/tinyos-1.x/tos/interfaces/RadioCoordinator.nc"
void MicaHighSpeedRadioM$RadioReceiveCoordinator$byte(TOS_MsgPtr arg_0x8bbdd78, uint8_t arg_0x8bbdec8);
static   
#line 33
void MicaHighSpeedRadioM$RadioReceiveCoordinator$startSymbol(uint8_t arg_0x8bbd668, uint8_t arg_0x8bbd7b0, TOS_MsgPtr arg_0x8bbd900);
static  
# 33 "/opt/tinyos-1.x/tos/platform/pc/SpiByteFifo.nc"
result_t MicaHighSpeedRadioM$SpiByteFifo$send(uint8_t arg_0x8bb5648);
static  
...
static  
#line 35
result_t MicaHighSpeedRadioM$SpiByteFifo$startReadBytes(uint16_t arg_0x8bb5d08);
static  
#line 34
...
static   
# 38 "/opt/tinyos-1.x/tos/interfaces/RadioCoordinator.nc"
void MicaHighSpeedRadioM$RadioSendCoordinator$byte(TOS_MsgPtr arg_0x8bbdd78, uint8_t arg_0x8bbdec8);
static   
#line 33
void MicaHighSpeedRadioM$RadioSendCoordinator$startSymbol(uint8_t arg_0x8bbd668, uint8_t arg_0x8bbd7b0, TOS_MsgPtr arg_0x8bbd900);
static  
...
enum MicaHighSpeedRadioM$__nesc_unnamed4356 {
...
result_t SecDedEncoding$Code$decodeDone(char arg_0x8bb65d8, char arg_0x8bb6718);
static  result_t SecDedEncoding$Code$encodeDone(char arg_0x8bb6b20);
# 44 "/opt/tinyos-1.x/tos/platform/pc/SecDedEncoding.nc"
enum SecDedEncoding$__nesc_unnamed4358 {
...
enum ChannelMonC$__nesc_unnamed4359 {
...
result_t SpiByteFifoC$SpiByteFifo$dataReady(uint8_t arg_0x8bb0978);
...
enum SpiByteFifoC$__nesc_unnamed4361 {
  SpiByteFifoC$IDLE, 
  SpiByteFifoC$FULL, 
  SpiByteFifoC$OPEN, 
...
static  
# 75 "/opt/tinyos-1.x/tos/interfaces/ReceiveMsg.nc"
TOS_MsgPtr CrcFilter$UpperReceive$receive(TOS_MsgPtr arg_0x898dda8);
static inline  
# 52 "/opt/tinyos-1.x/tos/system/CrcFilter.nc"
TOS_MsgPtr CrcFilter$LowerReceive$receive(TOS_MsgPtr msg);
static  
# 67 "/opt/tinyos-1.x/tos/interfaces/BareSendMsg.nc"
result_t UARTNoCRCPacketM$Send$sendDone(TOS_MsgPtr arg_0x898ba90, result_t arg_0x898bbe0);
static inline  
...
static inline  
#line 105
uint16_t TrustM$Trust$areReportsConsistent(uint16_t oneHopReportedSent, uint16_t twoHopReportedReceived);
...
void TransactionTableM$Messaging$putReportRequestMsgInOutQ(TOS_Msg arg_0x8b16310[], uint16_t *arg_0x8b16480, uint16_t arg_0x8b165d8, uint16_t *arg_0x8b16748, uint16_t arg_0x8b168a0, uint16_t arg_0x8b169f8, uint16_t arg_0x8b16b50, uint16_t arg_0x8b16cb0, uint32_t arg_0x8b16e08);
static  
# 17 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/Trust.nc"
float TransactionTableM$Trust$calculateLP(uint32_t arg_0x8aef118, uint32_t arg_0x8aef268);
static  
#line 16
float TransactionTableM$Trust$calculateAV(uint32_t arg_0x8aeebc0, uint32_t arg_0x8aeed10);
static  
#line 15
float TransactionTableM$Trust$calculateRH(uint32_t arg_0x8aee668, uint32_t arg_0x8aee7b8);
static  


float TransactionTableM$Trust$calculateOverallTrust(float arg_0x8aefbc0, float arg_0x8aefd00, float arg_0x8aefe40, float arg_0x8aec010, float arg_0x8aec150);
static  
#line 18
float TransactionTableM$Trust$calculatePR(uint32_t arg_0x8aef670, uint32_t arg_0x8aef7c0);
static  
#line 14
float TransactionTableM$Trust$calculateFP(uint32_t arg_0x8aee110, uint32_t arg_0x8aee260);
static  
...
uint16_t TransactionTableM$Trust$areReportsConsistent(uint16_t arg_0x8aec598, uint16_t arg_0x8aec6f8);
static  
# 18 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/Attack.nc"
uint16_t TransactionTableM$Attack$ifLoopCreatorGetParent(uint16_t arg_0x8acdd10);
static  
...
static  
# 56 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/TransactionTableM.nc"
...
result_t MessagingM$NeighborTable$addNeighborsToDiscMsg(Disc_Rec_t arg_0x8ac90d8[], uint16_t arg_0x8ac9238, Neighbor_Rec_withTrust_t *arg_0x8ac93e0[]);
static  
...
# 75 "/opt/tinyos-1.x/tos/interfaces/ReceiveMsg.nc"
inline static  TOS_MsgPtr AMStandard$ReceiveMsg$receive(uint8_t arg_0x8b9ea00, TOS_MsgPtr arg_0x898dda8){
#line 75
  struct TOS_Msg *result;
#line 75

#line 75
  switch (arg_0x8b9ea00) {
#line 75
    case DISCOVERY_MSG_TYPE:
#line 75
      result = SarpM$Receive$receive(arg_0x898dda8);
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      result = AMStandard$ReceiveMsg$default$receive(arg_0x8b9ea00, arg_0x898dda8);
#line 75
    }
#line 75
...
inline static  void SarpM$Messaging$putSpecificReportResponseMsgInOutQ(TOS_Msg arg_0x8ae6360[], uint16_t *arg_0x8ae64d0, uint16_t arg_0x8ae6628, uint16_t *arg_0x8ae6798, uint16_t arg_0x8ae68f0, uint16_t arg_0x8ae6a48, uint32_t arg_0x8ae6ba0, uint16_t arg_0x8ae6cf8, uint16_t arg_0x8ae6e58, uint16_t arg_0x8ae6fb8, uint16_t arg_0x8ae7118, uint16_t arg_0x8ae7278){
#line 34
  MessagingM$Messaging$putSpecificReportResponseMsgInOutQ(arg_0x8ae6360, arg_0x8ae64d0, arg_0x8ae6628, arg_0x8ae6798, arg_0x8ae68f0, arg_0x8ae6a48, arg_0x8ae6ba0, arg_0x8ae6cf8, arg_0x8ae6e58, arg_0x8ae6fb8, arg_0x8ae7118, arg_0x8ae7278);
#line 34
}
#line 34
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
inline static  result_t SarpM$Timer8$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0){
#line 59
  unsigned char result;
#line 59

#line 59
  result = TimerM$Timer$start(5, arg_0x8a54f78, arg_0x8a550d0);
#line 59
...
inline static  void SarpM$TransactionTable$addToTransactionCheckQ(Check_Transaction_Record_t arg_0x8af4bd8[], Transaction_Record_Ptr arg_0x8af4d30, uint16_t arg_0x8af4e80, uint16_t arg_0x8af4fd0, uint16_t *arg_0x8af5140, uint16_t arg_0x8af5298, uint16_t *arg_0x8af5408){
#line 77
  TransactionTableM$TransactionTable$addToTransactionCheckQ(arg_0x8af4bd8, arg_0x8af4d30, arg_0x8af4e80, arg_0x8af4fd0, arg_0x8af5140, arg_0x8af5298, arg_0x8af5408);
#line 77
}
#line 77
# 29 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/Messaging.nc"
inline static  void SarpM$Messaging$putSpecificReportRequestMsgInOutQ(TOS_Msg arg_0x8b17278[], uint16_t *arg_0x8b173e8, uint16_t arg_0x8b17540, uint16_t *arg_0x8b176b0, uint16_t arg_0x8b17810, uint16_t arg_0x8b17968, uint16_t arg_0x8b17ac0, uint16_t arg_0x8b17c18, uint16_t arg_0x8b17d78, uint32_t arg_0x8b17ed0){
#line 29
  MessagingM$Messaging$putSpecificReportRequestMsgInOutQ(arg_0x8b17278, arg_0x8b173e8, arg_0x8b17540, arg_0x8b176b0, arg_0x8b17810, arg_0x8b17968, arg_0x8b17ac0, arg_0x8b17c18, arg_0x8b17d78, arg_0x8b17ed0);
#line 29
}
#line 29
# 32 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/TransactionTable.nc"
inline static  Transaction_Record_Ptr SarpM$TransactionTable$getThisTransactionPtr(Transaction_Record_t arg_0x8ac5ed0[], uint32_t arg_0x8ac2060){
#line 32
  struct Transaction_Record_t *result;
#line 32

#line 32
  result = TransactionTableM$TransactionTable$getThisTransactionPtr(arg_0x8ac5ed0, arg_0x8ac2060);
#line 32
...
inline static  void SarpM$Messaging$putEndToEndReportResponseMsgInOutQ(TOS_Msg arg_0x8ae5a20[], uint16_t *arg_0x8ae5b90, uint16_t arg_0x8ae5ce8, uint16_t *arg_0x8ae5e58, uint16_t arg_0x8ae2010, uint16_t arg_0x8ae2168, uint32_t arg_0x8ae22c0, uint16_t arg_0x8ae2418, uint16_t arg_0x8ae2578, uint16_t arg_0x8ae26d0){
#line 49
  MessagingM$Messaging$putEndToEndReportResponseMsgInOutQ(arg_0x8ae5a20, arg_0x8ae5b90, arg_0x8ae5ce8, arg_0x8ae5e58, arg_0x8ae2010, arg_0x8ae2168, arg_0x8ae22c0, arg_0x8ae2418, arg_0x8ae2578, arg_0x8ae26d0);
#line 49
}
#line 49
#line 39
inline static  void SarpM$Messaging$putReportResponseNoForwardMsgInOutQ(TOS_Msg arg_0x8ae7700[], uint16_t *arg_0x8ae7870, uint16_t arg_0x8ae79c8, uint16_t *arg_0x8ae7b38, uint16_t arg_0x8ae7c90, uint32_t arg_0x8ae7de8, uint16_t arg_0x8ae7f40, uint16_t arg_0x8ae40b0, uint16_t arg_0x8ae4210, uint16_t arg_0x8ae4370, uint16_t arg_0x8ae44c8){
#line 39
  MessagingM$Messaging$putReportResponseNoForwardMsgInOutQ(arg_0x8ae7700, arg_0x8ae7870, arg_0x8ae79c8, arg_0x8ae7b38, arg_0x8ae7c90, arg_0x8ae7de8, arg_0x8ae7f40, arg_0x8ae40b0, arg_0x8ae4210, arg_0x8ae4370, arg_0x8ae44c8);
#line 39
}
#line 39
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
inline static  result_t SarpM$Timer7$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0){
#line 59
  unsigned char result;
#line 59

#line 59
  result = TimerM$Timer$start(4, arg_0x8a54f78, arg_0x8a550d0);
#line 59
...
inline static  uint16_t SarpM$TransactionTable$getTransactionParent(Transaction_Record_t arg_0x8ac2d10[], uint32_t arg_0x8ac2e68){
#line 42
  unsigned short result;
#line 42

#line 42
  result = TransactionTableM$TransactionTable$getTransactionParent(arg_0x8ac2d10, arg_0x8ac2e68);
#line 42
...
#line 42
# 24 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/Messaging.nc"
inline static  void SarpM$Messaging$putReportRequestMsgInOutQ(TOS_Msg arg_0x8b16310[], uint16_t *arg_0x8b16480, uint16_t arg_0x8b165d8, uint16_t *arg_0x8b16748, uint16_t arg_0x8b168a0, uint16_t arg_0x8b169f8, uint16_t arg_0x8b16b50, uint16_t arg_0x8b16cb0, uint32_t arg_0x8b16e08){
#line 24
  MessagingM$Messaging$putReportRequestMsgInOutQ(arg_0x8b16310, arg_0x8b16480, arg_0x8b165d8, arg_0x8b16748, arg_0x8b168a0, arg_0x8b169f8, arg_0x8b16b50, arg_0x8b16cb0, arg_0x8b16e08);
#line 24
}
#line 24
static inline  
# 631 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/TransactionTableM.nc"
void TransactionTableM$TransactionTable$setOriginatorPacketCount(Transaction_Record_t transactionRecords[], uint32_t transaction_id, uint16_t packetCount)
{
...
inline static  void SarpM$TransactionTable$setOriginatorPacketCount(Transaction_Record_t arg_0x8af25f8[], uint32_t arg_0x8af2750, uint16_t arg_0x8af28a8){
#line 87
  TransactionTableM$TransactionTable$setOriginatorPacketCount(arg_0x8af25f8, arg_0x8af2750, arg_0x8af28a8);
#line 87
}
#line 87
# 14 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/Messaging.nc"
inline static  void SarpM$Messaging$putDataMessageInOutQ(TOS_Msg arg_0x8aedd68[], uint16_t *arg_0x8aeded8, uint16_t arg_0x8aea060, uint16_t *arg_0x8aea1d0, uint16_t arg_0x8aea328, uint16_t arg_0x8aea480, uint32_t arg_0x8aea5d8, uint16_t arg_0x8aea730, uint16_t arg_0x8aea880, uint16_t arg_0x8aea9d8, uint16_t arg_0x8aeab30, uint16_t arg_0x8aeac88, uint16_t arg_0x8aeade8){
#line 14
  MessagingM$Messaging$putDataMessageInOutQ(arg_0x8aedd68, arg_0x8aeded8, arg_0x8aea060, arg_0x8aea1d0, arg_0x8aea328, arg_0x8aea480, arg_0x8aea5d8, arg_0x8aea730, arg_0x8aea880, arg_0x8aea9d8, arg_0x8aeab30, arg_0x8aeac88, arg_0x8aeade8);
#line 14
}
#line 14
static inline  
# 357 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/TransactionTableM.nc"
void TransactionTableM$TransactionTable$markAsLoop(Transaction_Record_Ptr thisTransaction)
{
...
inline static  void SarpM$TransactionTable$markAsLoop(Transaction_Record_Ptr arg_0x8ac3280){
#line 67
  TransactionTableM$TransactionTable$markAsLoop(arg_0x8ac3280);
#line 67
}
#line 67
static inline  
...
inline static  uint16_t SarpM$Attack$isLoopCreator(uint16_t arg_0x8ade168){
#line 26
  unsigned short result;
#line 26

#line 26
  result = AttackM$Attack$isLoopCreator(arg_0x8ade168);
#line 26
...
#line 26
static inline  
# 668 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/TransactionTableM.nc"
uint16_t TransactionTableM$TransactionTable$isALoop(Transaction_Record_t transactions[], uint32_t transaction_id, uint16_t senderNow, uint16_t sequenceNumberIn)
{
  for (tLoopCounter = 0; tLoopCounter < CIRCULAR_BUFFER_SIZE; tLoopCounter++) 
    {
...
# 97 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/TransactionTable.nc"
inline static  uint16_t SarpM$TransactionTable$isALoop(Transaction_Record_t arg_0x8af39d0[], uint32_t arg_0x8af3b28, uint16_t arg_0x8af3c80, uint16_t arg_0x8af3de0){
#line 97
  unsigned short result;
#line 97

#line 97
  result = TransactionTableM$TransactionTable$isALoop(arg_0x8af39d0, arg_0x8af3b28, arg_0x8af3c80, arg_0x8af3de0);
#line 97
...
# 10 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/Attack.nc"
inline static  uint16_t SarpM$Attack$sfDropThis(uint16_t arg_0x8acd610, uint16_t arg_0x8acd768, uint16_t *arg_0x8acd8e0){
#line 10
  unsigned short result;
#line 10

#line 10
  result = AttackM$Attack$sfDropThis(arg_0x8acd610, arg_0x8acd768, arg_0x8acd8e0);
#line 10
...
inline static  result_t SarpM$TransactionTable$initializeTransaction(Transaction_Record_t arg_0x8ac7b90[], uint32_t arg_0x8ac7ce8, uint16_t arg_0x8ac7e40, uint16_t arg_0x8ac4010, Neighbor_Rec_withTrust_t *arg_0x8ac41b8[], uint16_t arg_0x8ac4318, uint16_t arg_0x8ac4468, uint16_t arg_0x8ac45c0, Neighbor_Rec_withTrust_t *arg_0x8ac4758[], uint16_t arg_0x8ac48b0, Neighbor_Rec_withTrust_t *arg_0x8ac4a50[], uint16_t arg_0x8ac4ba8, uint16_t arg_0x8ac4cf8){
#line 16
  unsigned char result;
#line 16

#line 16
  result = TransactionTableM$TransactionTable$initializeTransaction(arg_0x8ac7b90, arg_0x8ac7ce8, arg_0x8ac7e40, arg_0x8ac4010, arg_0x8ac41b8, arg_0x8ac4318, arg_0x8ac4468, arg_0x8ac45c0, arg_0x8ac4758, arg_0x8ac48b0, arg_0x8ac4a50, arg_0x8ac4ba8, arg_0x8ac4cf8);
#line 16
...
inline static  uint8_t SarpM$TransactionTable$transactionExistsAlready(Transaction_Record_t arg_0x8ac5228[], uint32_t arg_0x8ac5380, uint16_t arg_0x8ac54d0){
#line 22
  unsigned char result;
#line 22

#line 22
  result = TransactionTableM$TransactionTable$transactionExistsAlready(arg_0x8ac5228, arg_0x8ac5380, arg_0x8ac54d0);
#line 22
...
inline static  void SarpM$Messaging$putNeighborDiscoveryControlMsgInOutQ(TOS_Msg arg_0x8ae3510[], uint16_t *arg_0x8ae3680, uint16_t arg_0x8ae37d8, uint16_t *arg_0x8ae3948, uint16_t arg_0x8ae3a98, uint16_t arg_0x8ae3bf0, uint16_t arg_0x8ae3d40){
#line 60
  MessagingM$Messaging$putNeighborDiscoveryControlMsgInOutQ(arg_0x8ae3510, arg_0x8ae3680, arg_0x8ae37d8, arg_0x8ae3948, arg_0x8ae3a98, arg_0x8ae3bf0, arg_0x8ae3d40);
#line 60
}
#line 60
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
inline static  result_t SarpM$Timer4$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0){
#line 59
  unsigned char result;
#line 59

#line 59
  result = TimerM$Timer$start(2, arg_0x8a54f78, arg_0x8a550d0);
#line 59
...
inline static  void SarpM$Messaging$putStartMsgInOutQ(TOS_Msg arg_0x8ae2b38[], uint16_t *arg_0x8ae2ca8, uint16_t arg_0x8ae2e00, uint16_t *arg_0x8ae2f70, uint16_t arg_0x8ae30c0){
#line 54
  MessagingM$Messaging$putStartMsgInOutQ(arg_0x8ae2b38, arg_0x8ae2ca8, arg_0x8ae2e00, arg_0x8ae2f70, arg_0x8ae30c0);
#line 54
}
#line 54
# 17 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/NeighborTable.nc"
inline static  result_t SarpM$NeighborTable$processNeighborFromDiscMsg(Neighbor_Rec_withTrust_t arg_0x8ac8260[], Neighbor_Rec_withTrust_t *arg_0x8ac8408[], uint16_t *arg_0x8ac8578, uint16_t *arg_0x8ac86f0, uint16_t arg_0x8ac8848, uint8_t arg_0x8ac8990, uint16_t arg_0x8ac8af0, uint16_t *arg_0x8ac8c60){
#line 17
  unsigned char result;
#line 17

#line 17
  result = NeighborTableM$NeighborTable$processNeighborFromDiscMsg(arg_0x8ac8260, arg_0x8ac8408, arg_0x8ac8578, arg_0x8ac86f0, arg_0x8ac8848, arg_0x8ac8990, arg_0x8ac8af0, arg_0x8ac8c60);
#line 17
              ...
              if (type == REPORT_RESPONSE_NO_FORWARD_MSG_TYPE) 
                {
                  ...
                  dbg(DBG_USR3, "%d heard a Report Response NO Forward message\r\n", SarpM$myAddr[tos_state.current_node]);
                              ...
                              if (SarpM$reportRespNoForwardMsgIn[tos_state.current_node]->packetsReceivedFrom == SarpM$myAddr[tos_state.current_node]) 
                                {
                                  ...
                                  dbg(DBG_USR3, "%d reports the NO forward message is a ONE hop message\r\n", SarpM$myAddr[tos_state.current_node]);
                                ...
                                if (SarpM$reportRespNoForwardMsgIn[tos_state.current_node]->packetsReceivedFrom == SarpM$transactionRecords[tos_state.current_node][SarpM$transactionCounter[tos_state.current_node]].packetsForwardedTo) 
                                  {
                                    ...
                                    dbg(DBG_USR3, "%d reports the NO forward message is a TWO hop message\r\n", SarpM$myAddr[tos_state.current_node]);
...
# 48 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
inline static  result_t SarpM$SendDisc$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8){
#line 48
  unsigned char result;
#line 48

#line 48
  result = AMStandard$SendMsg$send(DISCOVERY_MSG_TYPE, arg_0x8ace060, arg_0x8ace1a8, arg_0x8ace2f8);
#line 48
...
# 58 "/opt/tinyos-1.x/tos/interfaces/BareSendMsg.nc"
inline static  result_t AMStandard$RadioSend$send(TOS_MsgPtr arg_0x898b578){
#line 58
  unsigned char result;
#line 58

#line 58
  result = PacketSink$Send$send(arg_0x898b578);
#line 58
  result = rcombine(result, MicaHighSpeedRadioM$Send$send(arg_0x898b578));
#line 58
...
# 58 "/opt/tinyos-1.x/tos/interfaces/BareSendMsg.nc"
inline static  result_t AMStandard$UARTSend$send(TOS_MsgPtr arg_0x898b578){
#line 58
  unsigned char result;
#line 58

#line 58
  result = UARTNoCRCPacketM$Send$send(arg_0x898b578);
#line 58
  result = rcombine(result, UARTNoCRCPacketM$Send$send(arg_0x898b578));
#line 58
...
# 67 "/opt/tinyos-1.x/tos/interfaces/BareSendMsg.nc"
inline static  result_t UARTNoCRCPacketM$Send$sendDone(TOS_MsgPtr arg_0x898ba90, result_t arg_0x898bbe0){
#line 67
  unsigned char result;
#line 67

#line 67
  result = AMStandard$UARTSend$sendDone(arg_0x898ba90, arg_0x898bbe0);
#line 67
  result = rcombine(result, AMStandard$UARTSend$sendDone(arg_0x898ba90, arg_0x898bbe0));
#line 67
...
# 49 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
inline static  result_t AMStandard$SendMsg$sendDone(uint8_t arg_0x8b9e448, TOS_MsgPtr arg_0x8ace718, result_t arg_0x8ace868){
#line 49
  unsigned char result;
#line 49

#line 49
  switch (arg_0x8b9e448) {
#line 49
    case DISCOVERY_MSG_TYPE:
#line 49
      result = SarpM$SendUDisc$sendDone(arg_0x8ace718, arg_0x8ace868);
#line 49
      result = rcombine(result, SarpM$SendDisc$sendDone(arg_0x8ace718, arg_0x8ace868));
#line 49
      break;
#line 49
    case CONTROL_MSG_TYPE:
#line 49
      result = SarpM$SendStart$sendDone(arg_0x8ace718, arg_0x8ace868);
#line 49
      break;
#line 49
    case DATA_MSG_TYPE:
#line 49
      result = SarpM$SendData$sendDone(arg_0x8ace718, arg_0x8ace868);
#line 49
      break;
#line 49
    case REPORT_MSG_TYPE:
#line 49
      result = SarpM$SendReport$sendDone(arg_0x8ace718, arg_0x8ace868);
#line 49
      break;
#line 49
    case REPORT_REQUEST_MSG_TYPE:
#line 49
      result = SarpM$SendReportRequest$sendDone(arg_0x8ace718, arg_0x8ace868);
#line 49
      break;
#line 49
    case REPORT_RESPONSE_NO_FORWARD_MSG_TYPE:
#line 49
      result = SarpM$SendReportNoForwardResponse$sendDone(arg_0x8ace718, arg_0x8ace868);
#line 49
      break;
#line 49
    case REPORT_RESPONSE_FORWARD_MSG_TYPE:
#line 49
      result = SarpM$SendReportForwardResponse$sendDone(arg_0x8ace718, arg_0x8ace868);
#line 49
      break;
#line 49
    case END_TO_END_REPORT_RESPONSE_MSG_TYPE:
#line 49
      result = SarpM$SendEndToEndReportResponse$sendDone(arg_0x8ace718, arg_0x8ace868);
#line 49
      break;
#line 49
    case SPECIFIC_REPORT_REQUEST_MSG_TYPE:
#line 49
      result = SarpM$SendSpecificReportRequest$sendDone(arg_0x8ace718, arg_0x8ace868);
#line 49
      break;
#line 49
    case SPECIFIC_REPORT_RESPONSE_MSG_TYPE:
#line 49
      result = SarpM$SendSpecificReportResponse$sendDone(arg_0x8ace718, arg_0x8ace868);
#line 49
      break;
#line 49
    default:
#line 49
      result = AMStandard$SendMsg$default$sendDone(arg_0x8b9e448, arg_0x8ace718, arg_0x8ace868);
#line 49
    }
#line 49
...
# 48 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
inline static  result_t SarpM$SendStart$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8){
#line 48
  unsigned char result;
#line 48

#line 48
  result = AMStandard$SendMsg$send(CONTROL_MSG_TYPE, arg_0x8ace060, arg_0x8ace1a8, arg_0x8ace2f8);
#line 48
...
#line 48
# 48 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
inline static  result_t SarpM$SendData$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8){
#line 48
  unsigned char result;
#line 48

#line 48
  result = AMStandard$SendMsg$send(DATA_MSG_TYPE, arg_0x8ace060, arg_0x8ace1a8, arg_0x8ace2f8);
#line 48
...
#line 48
# 48 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
inline static  result_t SarpM$SendReportRequest$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8){
#line 48
  unsigned char result;
#line 48

#line 48
  result = AMStandard$SendMsg$send(REPORT_REQUEST_MSG_TYPE, arg_0x8ace060, arg_0x8ace1a8, arg_0x8ace2f8);
#line 48
...
inline static  uint16_t SarpM$Attack$isNoResponder(uint16_t arg_0x8ade580){
#line 34
  unsigned short result;
#line 34

#line 34
  result = AttackM$Attack$isNoResponder(arg_0x8ade580);
#line 34
...
#line 34
# 48 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
inline static  result_t SarpM$SendReportNoForwardResponse$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8){
#line 48
  unsigned char result;
#line 48

#line 48
  result = AMStandard$SendMsg$send(REPORT_RESPONSE_NO_FORWARD_MSG_TYPE, arg_0x8ace060, arg_0x8ace1a8, arg_0x8ace2f8);
#line 48
...
#line 48
# 48 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
inline static  result_t SarpM$SendReportForwardResponse$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8){
#line 48
  unsigned char result;
#line 48

#line 48
  result = AMStandard$SendMsg$send(REPORT_RESPONSE_FORWARD_MSG_TYPE, arg_0x8ace060, arg_0x8ace1a8, arg_0x8ace2f8);
#line 48
...
#line 48
# 48 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
inline static  result_t SarpM$SendEndToEndReportResponse$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8){
#line 48
  unsigned char result;
#line 48

#line 48
  result = AMStandard$SendMsg$send(END_TO_END_REPORT_RESPONSE_MSG_TYPE, arg_0x8ace060, arg_0x8ace1a8, arg_0x8ace2f8);
#line 48
...
#line 48
# 48 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
inline static  result_t SarpM$SendSpecificReportRequest$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8){
#line 48
  unsigned char result;
#line 48

#line 48
  result = AMStandard$SendMsg$send(SPECIFIC_REPORT_REQUEST_MSG_TYPE, arg_0x8ace060, arg_0x8ace1a8, arg_0x8ace2f8);
#line 48
...
#line 48
# 48 "/opt/tinyos-1.x/tos/interfaces/SendMsg.nc"
inline static  result_t SarpM$SendSpecificReportResponse$send(uint16_t arg_0x8ace060, uint8_t arg_0x8ace1a8, TOS_MsgPtr arg_0x8ace2f8){
#line 48
  unsigned char result;
#line 48

#line 48
  result = AMStandard$SendMsg$send(SPECIFIC_REPORT_RESPONSE_MSG_TYPE, arg_0x8ace060, arg_0x8ace1a8, arg_0x8ace2f8);
#line 48
...
#line 122
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
inline static  result_t SarpM$Timer1$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0){
#line 59
  unsigned char result;
#line 59

#line 59
  result = TimerM$Timer$start(0, arg_0x8a54f78, arg_0x8a550d0);
#line 59
...
# 105 "/opt/tinyos-1.x/tos/interfaces/Clock.nc"
inline static   void TimerM$Clock$setInterval(uint8_t arg_0x8a417b8){
#line 105
  HPLClock$Clock$setInterval(arg_0x8a417b8);
#line 105
}
#line 105
static inline   
...
inline static  float TransactionTableM$Trust$calculateOverallTrust(float arg_0x8aefbc0, float arg_0x8aefd00, float arg_0x8aefe40, float arg_0x8aec010, float arg_0x8aec150){
#line 19
  float result;
#line 19

#line 19
  result = TrustM$Trust$calculateOverallTrust(arg_0x8aefbc0, arg_0x8aefd00, arg_0x8aefe40, arg_0x8aec010, arg_0x8aec150);
#line 19
...
#line 19
static inline  
# 78 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/TrustM.nc"
float TrustM$Trust$calculatePR(uint32_t GPB_l, uint32_t BPB_l)
{
...
inline static  float TransactionTableM$Trust$calculatePR(uint32_t arg_0x8aef670, uint32_t arg_0x8aef7c0){
#line 18
  float result;
#line 18

#line 18
  result = TrustM$Trust$calculatePR(arg_0x8aef670, arg_0x8aef7c0);
#line 18
...
#line 18
#line 17
inline static  float TransactionTableM$Trust$calculateLP(uint32_t arg_0x8aef118, uint32_t arg_0x8aef268){
#line 17
  float result;
#line 17

#line 17
  result = TrustM$Trust$calculateLP(arg_0x8aef118, arg_0x8aef268);
#line 17
...
#line 17
#line 16
inline static  float TransactionTableM$Trust$calculateAV(uint32_t arg_0x8aeebc0, uint32_t arg_0x8aeed10){
#line 16
  float result;
#line 16

#line 16
  result = TrustM$Trust$calculateAV(arg_0x8aeebc0, arg_0x8aeed10);
#line 16
...
#line 16
#line 15
inline static  float TransactionTableM$Trust$calculateRH(uint32_t arg_0x8aee668, uint32_t arg_0x8aee7b8){
#line 15
  float result;
#line 15

#line 15
  result = TrustM$Trust$calculateRH(arg_0x8aee668, arg_0x8aee7b8);
#line 15
...
#line 15
#line 14
inline static  float TransactionTableM$Trust$calculateFP(uint32_t arg_0x8aee110, uint32_t arg_0x8aee260){
#line 14
  float result;
#line 14

#line 14
  result = TrustM$Trust$calculateFP(arg_0x8aee110, arg_0x8aee260);
#line 14
...
#line 14
static inline  
# 688 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/TransactionTableM.nc"
void TransactionTableM$TransactionTable$doDynamicForgetting(Neighbor_Rec_withTrust_t neighbors[], uint16_t numNeighbors, uint16_t whoIAm)
{
  for (tnLoopCounter = 0; tnLoopCounter < numNeighbors; tnLoopCounter++) 
    {
#line 706
      dbg(DBG_USR3, "[%d] FP: (%d / (%d + %d)) * %f", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.GFB, neighbors[tnLoopCounter].trust.GFB, neighbors[tnLoopCounter].trust.BFB, 1.0 + neighbors[tnLoopCounter].trust.trustFP * 0.20);

      neighbors[tnLoopCounter].trust.trustFP = TransactionTableM$Trust$calculateFP(neighbors[tnLoopCounter].trust.GFB, neighbors[tnLoopCounter].trust.BFB) * (1.0 + neighbors[tnLoopCounter].trust.trustFP * 0.20);
      if (neighbors[tnLoopCounter].trust.trustFP > 1) {
#line 709
        neighbors[tnLoopCounter].trust.trustFP = 1.0;
        }
      else {
#line 710
        if (neighbors[tnLoopCounter].trust.trustFP == 0) {
#line 710
          neighbors[tnLoopCounter].trust.trustFP = 0.01;
          }
        }
#line 711
      neighbors[tnLoopCounter].trust.GFB = neighbors[tnLoopCounter].trust.trustFP * 100;
      neighbors[tnLoopCounter].trust.BFB = 100 - neighbors[tnLoopCounter].trust.GFB;

      dbg(DBG_USR3, " = %f\n", neighbors[tnLoopCounter].trust.trustFP);

      dbg(DBG_USR3, "[%d] RH: (%d / (%d + %d)) * %f", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.GRB, neighbors[tnLoopCounter].trust.GRB, neighbors[tnLoopCounter].trust.BRB, 1.0 + neighbors[tnLoopCounter].trust.trustRH * 0.20);

      neighbors[tnLoopCounter].trust.trustRH = TransactionTableM$Trust$calculateRH(neighbors[tnLoopCounter].trust.GRB, neighbors[tnLoopCounter].trust.BRB) * (1.0 + neighbors[tnLoopCounter].trust.trustRH * 0.20);
      if (neighbors[tnLoopCounter].trust.trustRH > 1) {
#line 719
        neighbors[tnLoopCounter].trust.trustRH = 1.0;
        }
      else {
#line 720
        if (neighbors[tnLoopCounter].trust.trustRH == 0) {
#line 720
          neighbors[tnLoopCounter].trust.trustRH = 0.01;
          }
        }
#line 721
      neighbors[tnLoopCounter].trust.GRB = neighbors[tnLoopCounter].trust.trustRH * 100;
      neighbors[tnLoopCounter].trust.BRB = 100 - neighbors[tnLoopCounter].trust.GRB;

      dbg(DBG_USR3, " = %f\n", neighbors[tnLoopCounter].trust.trustRH);

      dbg(DBG_USR3, "[%d] AV: (%d / (%d + %d)) * %f", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.GAB, neighbors[tnLoopCounter].trust.GAB, neighbors[tnLoopCounter].trust.BAB, 1.0 + neighbors[tnLoopCounter].trust.trustAV * 0.20);

      neighbors[tnLoopCounter].trust.trustAV = TransactionTableM$Trust$calculateAV(neighbors[tnLoopCounter].trust.GAB, neighbors[tnLoopCounter].trust.BAB) * (1.0 + neighbors[tnLoopCounter].trust.trustAV * 0.20);
      if (neighbors[tnLoopCounter].trust.trustAV > 1) {
#line 729
        neighbors[tnLoopCounter].trust.trustAV = 1.0;
        }
      else {
#line 730
        if (neighbors[tnLoopCounter].trust.trustAV == 0) {
#line 730
          neighbors[tnLoopCounter].trust.trustAV = 0.01;
          }
        }
#line 731
      neighbors[tnLoopCounter].trust.GAB = neighbors[tnLoopCounter].trust.trustAV * 100;
      neighbors[tnLoopCounter].trust.BAB = 100 - neighbors[tnLoopCounter].trust.GAB;

      dbg(DBG_USR3, " = %f\n", neighbors[tnLoopCounter].trust.trustAV);

      dbg(DBG_USR3, "[%d] LP: (%d / (%d + %d)) * %f", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.GLB, neighbors[tnLoopCounter].trust.GLB, neighbors[tnLoopCounter].trust.BLB, 1.0 + neighbors[tnLoopCounter].trust.trustLP * 0.20);

      neighbors[tnLoopCounter].trust.trustLP = TransactionTableM$Trust$calculateLP(neighbors[tnLoopCounter].trust.GLB, neighbors[tnLoopCounter].trust.BLB) * (1.0 + neighbors[tnLoopCounter].trust.trustLP * 0.20);
      if (neighbors[tnLoopCounter].trust.trustLP > 1) {
#line 739
        neighbors[tnLoopCounter].trust.trustLP = 1.0;
        }
      else {
#line 740
        if (neighbors[tnLoopCounter].trust.trustLP == 0) {
#line 740
          neighbors[tnLoopCounter].trust.trustLP = 0.01;
          }
        }
#line 741
      neighbors[tnLoopCounter].trust.GLB = neighbors[tnLoopCounter].trust.trustLP * 100;
      neighbors[tnLoopCounter].trust.BLB = 100 - neighbors[tnLoopCounter].trust.GLB;

      dbg(DBG_USR3, " = %f\n", neighbors[tnLoopCounter].trust.trustLP);

      dbg(DBG_USR3, "[%d] PR: (%d / (%d + %d)) * %f", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.GPB, neighbors[tnLoopCounter].trust.GPB, neighbors[tnLoopCounter].trust.BPB, 1.0 + neighbors[tnLoopCounter].trust.trustPR * 0.20);

      neighbors[tnLoopCounter].trust.trustPR = TransactionTableM$Trust$calculatePR(neighbors[tnLoopCounter].trust.GPB, neighbors[tnLoopCounter].trust.BPB) * (1.0 + neighbors[tnLoopCounter].trust.trustPR * 0.20);
      if (neighbors[tnLoopCounter].trust.trustPR > 1) {
#line 749
        neighbors[tnLoopCounter].trust.trustPR = 1.0;
        }
      else {
#line 750
        if (neighbors[tnLoopCounter].trust.trustPR == 0) {
#line 750
          neighbors[tnLoopCounter].trust.trustPR = 0.01;
          }
        }
#line 751
      neighbors[tnLoopCounter].trust.GPB = neighbors[tnLoopCounter].trust.trustPR * 100;
      neighbors[tnLoopCounter].trust.BPB = 100 - neighbors[tnLoopCounter].trust.GPB;

      dbg(DBG_USR3, " = %f\n", neighbors[tnLoopCounter].trust.trustPR);
...
inline static  void SarpM$TransactionTable$doDynamicForgetting(Neighbor_Rec_withTrust_t arg_0x8af02f8[], uint16_t arg_0x8af0450, uint16_t arg_0x8af05a0){
#line 102
  TransactionTableM$TransactionTable$doDynamicForgetting(arg_0x8af02f8, arg_0x8af0450, arg_0x8af05a0);
#line 102
}
#line 102
static inline  
...
inline static  uint16_t SarpM$Attack$getNumThirtySeconds(uint16_t arg_0x8adedb8){
#line 45
  unsigned short result;
#line 45

#line 45
  result = AttackM$Attack$getNumThirtySeconds(arg_0x8adedb8);
#line 45
...
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
inline static  result_t SarpM$Timer6$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0){
#line 59
  unsigned char result;
#line 59

#line 59
  result = TimerM$Timer$start(3, arg_0x8a54f78, arg_0x8a550d0);
#line 59
...
#line 59
# 12 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/TrafficGenerator.nc"
inline static  float SarpM$TrafficGenerator$isTrafficGenerator(uint16_t arg_0x8b14408){
#line 12
  float result;
#line 12

#line 12
  result = TrafficGeneratorM$TrafficGenerator$isTrafficGenerator(arg_0x8b14408);
#line 12
...
#line 12
static inline  
# 105 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/TrustM.nc"
uint16_t TrustM$Trust$areReportsConsistent(uint16_t oneHopReportedSent, uint16_t twoHopReportedReceived)
{
...
# 21 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/Trust.nc"
inline static  uint16_t TransactionTableM$Trust$areReportsConsistent(uint16_t arg_0x8aec598, uint16_t arg_0x8aec6f8){
#line 21
  unsigned short result;
#line 21

#line 21
  result = TrustM$Trust$areReportsConsistent(arg_0x8aec598, arg_0x8aec6f8);
#line 21
...
#line 21
static inline  
# 366 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/TransactionTableM.nc"
void TransactionTableM$TransactionTable$processThisTransaction(Transaction_Record_Ptr thisTransaction, Neighbor_Rec_withTrust_t neighbors[], uint16_t numNeighbors, uint16_t whoIAm)
{
  ...
  dbg(DBG_USR3, "one_glb_inc:%d one_blb_inc:%d\n", one_glb_inc, one_blb_inc);
      ...
      if (thisTransaction->twoHopReported == 1) 
        {
          ...
          one_gfb_inc = thisTransaction->oneHopReportedPacketsReceived * GOOD_FORWARDING_BEHAVIOR_INCREMENT;
          one_bfb_inc = (thisTransaction->packetsForwarded - thisTransaction->twoHopReportedPacketsReceived) * BAD_FORWARDING_BEHAVIOR_INCREMENT;

          dbg(DBG_USR3, "%d: one_gfb_inc:%d one_bfb_inc:%d\n", 441, one_gfb_inc, one_bfb_inc);
          dbg(DBG_USR3, "%d: packetsForwarded:%d twoHopReportedPacketsReceived:%d result:%d\n", 442, thisTransaction->packetsForwarded, thisTransaction->twoHopReportedPacketsReceived, thisTransaction->packetsForwarded - thisTransaction->twoHopReportedPacketsReceived);
          ...
          if (TransactionTableM$Trust$areReportsConsistent(thisTransaction->oneHopReportedPacketsForwarded, thisTransaction->twoHopReportedPacketsReceived) == 1) 
            {
              ...
              dbg(DBG_USR3, "%d: one_grb_inc:%d one_brb_inc:%d two_grb_inc:%d two_brb_inc:%d\n", 457, one_grb_inc, one_brb_inc, two_grb_inc, two_brb_inc);
            }
          else 
...

            {
              ...
              dbg(DBG_USR3, "%d: one_grb_inc:%d one_brb_inc:%d two_grb_inc:%d two_brb_inc:%d\n", 471, one_grb_inc, one_brb_inc, two_grb_inc, two_brb_inc);
            }
          ...
          dbg(DBG_USR3, "%d: one_gab_inc:%d one_bab_inc:%d two_gab_inc:%d two_bab_inc:%d\n", 481, one_gab_inc, one_bab_inc, two_gab_inc, two_bab_inc);
        }
      else 

        {
          ...
          one_gfb_inc = thisTransaction->oneHopReportedPacketsReceived * 10;
          one_bfb_inc = (thisTransaction->packetsForwarded - thisTransaction->twoHopReportedPacketsReceived) * 50;
          ...
          dbg(DBG_USR3, "%d: one_gfb_inc:%d one_bfb_inc:%d one_grb_inc:%d one_brb_inc:%d one_gab_inc:%d one_bab_inc:%d two_gab_inc:%d two_bab_inc:%d\n", 506, one_gfb_inc, one_bfb_inc, one_grb_inc, one_brb_inc, one_gab_inc, one_bab_inc, two_gab_inc, two_bab_inc);
        }
    }
  else 
      ...
      if (thisTransaction->twoHopReported == 1) 
        {
          ...
          dbg(DBG_USR3, "%d: one_gfb_inc:%d one_bfb_inc:%d one_grb_inc:%d one_brb_inc:%d one_gab_inc:%d one_bab_inc:%d two_gab_inc:%d two_bab_inc:%d\n", 534, one_gfb_inc, one_bfb_inc, one_grb_inc, one_brb_inc, one_gab_inc, one_bab_inc, two_gab_inc, two_bab_inc);
        }
      else 

        {
          ...
          dbg(DBG_USR3, "%d: one_gab_inc:%d one_bab_inc:%d", 546, one_gab_inc, one_bab_inc);
        }
    }



  dbg(DBG_USR3, "%d: node_id:%d numNeighbors:%d whoIAm:%d GFBinc:%d BFBinc:%d GRBinc:%d BRBinc:%d GABinc:%d BABinc:%d GLBinc:%d BLBinc:%d\n", 552, thisTransaction->packetsForwardedTo, numNeighbors, whoIAm, one_gfb_inc, one_bfb_inc, one_grb_inc, one_brb_inc, one_gab_inc, one_bab_inc, one_glb_inc, one_blb_inc);
  dbg(DBG_USR3, "%d: node_id:%d numNeighbors:%d whoIAm:%d GFBinc:%d BFBinc:%d GRBinc:%d BRBinc:%d GABinc:%d BABinc:%d GLBinc:%d BLBinc:%d\n", 553, thisTransaction->packetsForwardedTo, numNeighbors, whoIAm, two_gfb_inc, two_bfb_inc, two_grb_inc, two_brb_inc, two_gab_inc, two_bab_inc, two_glb_inc, two_blb_inc);
...
inline static  void SarpM$TransactionTable$processThisTransaction(Transaction_Record_Ptr arg_0x8ac2480, Neighbor_Rec_withTrust_t arg_0x8ac2608[], uint16_t arg_0x8ac2760, uint16_t arg_0x8ac28b0){
#line 37
  TransactionTableM$TransactionTable$processThisTransaction(arg_0x8ac2480, arg_0x8ac2608, arg_0x8ac2760, arg_0x8ac28b0);
#line 37
}
#line 37
static inline  
# 610 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/TransactionTableM.nc"
uint16_t TransactionTableM$TransactionTable$getFromTransactionCheckQ(Check_Transaction_Record_t queue[], Transaction_Record_Ptr *ptr, uint16_t *ones, uint16_t *twos, uint16_t *readHere, uint16_t maxQueueSize, uint16_t *numInQueue)
{
...
inline static  uint16_t SarpM$TransactionTable$getFromTransactionCheckQ(Check_Transaction_Record_t arg_0x8af5888[], Transaction_Record_Ptr *arg_0x8af59f8, uint16_t *arg_0x8af5b60, uint16_t *arg_0x8af5cc8, uint16_t *arg_0x8af5e38, uint16_t arg_0x8af2010, uint16_t *arg_0x8af2180){
#line 82
  unsigned short result;
#line 82

#line 82
  result = TransactionTableM$TransactionTable$getFromTransactionCheckQ(arg_0x8af5888, arg_0x8af59f8, arg_0x8af5b60, arg_0x8af5cc8, arg_0x8af5e38, arg_0x8af2010, arg_0x8af2180);
#line 82
...
# 24 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/Messaging.nc"
inline static  void TransactionTableM$Messaging$putReportRequestMsgInOutQ(TOS_Msg arg_0x8b16310[], uint16_t *arg_0x8b16480, uint16_t arg_0x8b165d8, uint16_t *arg_0x8b16748, uint16_t arg_0x8b168a0, uint16_t arg_0x8b169f8, uint16_t arg_0x8b16b50, uint16_t arg_0x8b16cb0, uint32_t arg_0x8b16e08){
#line 24
  MessagingM$Messaging$putReportRequestMsgInOutQ(arg_0x8b16310, arg_0x8b16480, arg_0x8b165d8, arg_0x8b16748, arg_0x8b168a0, arg_0x8b169f8, arg_0x8b16b50, arg_0x8b16cb0, arg_0x8b16e08);
#line 24
}
#line 24
static inline  
# 645 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/TransactionTableM.nc"
uint16_t TransactionTableM$TransactionTable$sendReportRequestForThisTransaction(Transaction_Record_t transactionRecords[], uint32_t transaction_id, TOS_Msg outQ[], uint16_t *writeOutQHere, uint16_t maxQSize, uint16_t *numMsgOutQ, uint16_t myAddr)
{
...
inline static  uint16_t SarpM$TransactionTable$sendReportRequestForThisTransaction(Transaction_Record_t arg_0x8af2d18[], uint32_t arg_0x8af2e70, TOS_Msg arg_0x8af2fd8[], uint16_t *arg_0x8af3148, uint16_t arg_0x8af32a0, uint16_t *arg_0x8af3410, uint16_t arg_0x8af3560){
#line 92
  unsigned short result;
#line 92

#line 92
  result = TransactionTableM$TransactionTable$sendReportRequestForThisTransaction(arg_0x8af2d18, arg_0x8af2e70, arg_0x8af2fd8, arg_0x8af3148, arg_0x8af32a0, arg_0x8af3410, arg_0x8af3560);
#line 92
...
#line 92
static inline  
# 79 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/TransactionTableM.nc"
void TransactionTableM$TransactionTable$incrementSequenceNumber(Transaction_Record_t transactionRecords[], uint32_t transaction_id)
{
  for (tLoopCounter = 0; tLoopCounter < CIRCULAR_BUFFER_SIZE; tLoopCounter++) 
    {
...
inline static  void SarpM$TransactionTable$incrementSequenceNumber(Transaction_Record_t arg_0x8ac5920[], uint32_t arg_0x8ac5a78){
#line 27
  TransactionTableM$TransactionTable$incrementSequenceNumber(arg_0x8ac5920, arg_0x8ac5a78);
#line 27
}
#line 27
static inline  
...
void SarpM$sendDataMsg(void)
{
  ...
  if (SarpM$numDataMessagesInTrial[tos_state.current_node] <= 10) 
    {
      if (SarpM$myLevel[tos_state.current_node] != 255 && SarpM$myAddr[tos_state.current_node] != 0) 
        {
...
static inline  
# 157 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/NeighborTableM.nc"
result_t NeighborTableM$NeighborTable$addNeighborsToDiscMsg(Disc_Rec_t msgNeighbors[], uint16_t numOneHopNeighbors, Neighbor_Rec_withTrust_t *myOneHopNeighbors[])
{
...
# 23 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/NeighborTable.nc"
inline static  result_t MessagingM$NeighborTable$addNeighborsToDiscMsg(Disc_Rec_t arg_0x8ac90d8[], uint16_t arg_0x8ac9238, Neighbor_Rec_withTrust_t *arg_0x8ac93e0[]){
#line 23
  unsigned char result;
#line 23

#line 23
  result = NeighborTableM$NeighborTable$addNeighborsToDiscMsg(arg_0x8ac90d8, arg_0x8ac9238, arg_0x8ac93e0);
#line 23
...
inline static  void SarpM$Messaging$putDiscoveryMsgInOutQ(TOS_Msg arg_0x8aeb2e8[], uint16_t *arg_0x8aeb458, uint16_t arg_0x8aeb5b0, uint16_t *arg_0x8aeb720, uint16_t arg_0x8aeb870, uint16_t arg_0x8aeb9c0, uint16_t arg_0x8aebb18, uint16_t arg_0x8aebc78, Neighbor_Rec_withTrust_t *arg_0x8aebe20[]){
#line 19
  MessagingM$Messaging$putDiscoveryMsgInOutQ(arg_0x8aeb2e8, arg_0x8aeb458, arg_0x8aeb5b0, arg_0x8aeb720, arg_0x8aeb870, arg_0x8aeb9c0, arg_0x8aebb18, arg_0x8aebc78, arg_0x8aebe20);
#line 19
}
#line 19
static inline  
...
# 61 "/opt/tinyos-1.x/tos/interfaces/AbsoluteTimer.nc"
inline static  result_t SimpleTimeM$AbsoluteTimer$fired(uint8_t arg_0x8a9fc90){
#line 61
  unsigned char result;
#line 61

#line 61
    result = SimpleTimeM$AbsoluteTimer$default$fired(arg_0x8a9fc90);
#line 61
...
inline static   char SimpleTimeM$TimeUtil$compare(tos_time_t arg_0x8a32200, tos_time_t arg_0x8a32350){
#line 82
  char result;
#line 82

#line 82
  result = TimeUtilC$TimeUtil$compare(arg_0x8a32200, arg_0x8a32350);
#line 82
...
# 65 "/opt/tinyos-1.x/tos/interfaces/TimeUtil.nc"
inline static   tos_time_t SimpleTimeM$TimeUtil$addUint32(tos_time_t arg_0x8a39480, uint32_t arg_0x8a395d0){
#line 65
  struct __nesc_unnamed4347 result;
#line 65

#line 65
  result = TimeUtilC$TimeUtil$addUint32(arg_0x8a39480, arg_0x8a395d0);
#line 65
...
# 73 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
inline static  result_t TimerM$Timer$fired(uint8_t arg_0x8a26758){
#line 73
  unsigned char result;
#line 73

#line 73
  switch (arg_0x8a26758) {
#line 73
    case 0:
#line 73
...
#line 73
    default:
#line 73
      result = TimerM$Timer$default$fired(arg_0x8a26758);
#line 73
    }
#line 73
...
# 18 "/opt/tinyos-1.x/apps/sarp-0.3-dev/interfaces/Attack.nc"
inline static  uint16_t TransactionTableM$Attack$ifLoopCreatorGetParent(uint16_t arg_0x8acdd10){
#line 18
  unsigned short result;
#line 18

#line 18
  result = AttackM$Attack$ifLoopCreatorGetParent(arg_0x8acdd10);
#line 18
...
#line 985
  ...
  name.sin_addr.s_addr = inet_addr("172.90.3.76");
...
static inline  
# 191 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/NeighborTableM.nc"
uint16_t NeighborTableM$NeighborTable$getNewTransactionParent(Neighbor_Rec_withTrust_t *myOneHopNeighbors[], uint16_t numOneHopNeighbors, uint8_t myLevel_l, Neighbor_Rec_withTrust_t *myPeers[], uint16_t numPeers, Neighbor_Rec_withTrust_t *myChildren[], uint16_t numChildren, uint16_t dontPickMe, uint16_t dontPickMeEither, uint16_t reallyDontPickMe, uint16_t whoIAm)
{
...
#line 28
  result = NeighborTableM$NeighborTable$getNewTransactionParent(arg_0x8ac9860, arg_0x8ac99c0, arg_0x8ac9b10, arg_0x8ac9ca8, arg_0x8ac9e00, arg_0x8ac6010, arg_0x8ac6168, arg_0x8ac62c0, arg_0x8ac6420, arg_0x8ac6580, arg_0x8ac66d0);
#line 28
...
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
inline static  result_t SarpM$Timer2$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0){
#line 59
  unsigned char result;
#line 59

#line 59
  result = TimerM$Timer$start(1, arg_0x8a54f78, arg_0x8a550d0);
#line 59
...
#line 59
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
inline static  result_t SarpM$Timer10$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0){
#line 59
  unsigned char result;
#line 59

#line 59
  result = TimerM$Timer$start(7, arg_0x8a54f78, arg_0x8a550d0);
#line 59
...
inline static  uint16_t SarpM$Attack$isOnOffAttacker(uint16_t arg_0x8ade998){
#line 43
  unsigned short result;
#line 43

#line 43
  result = AttackM$Attack$isOnOffAttacker(arg_0x8ade998);
#line 43
...
#line 43
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
inline static  result_t SarpM$Timer9$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0){
#line 59
  unsigned char result;
#line 59

#line 59
  result = TimerM$Timer$start(6, arg_0x8a54f78, arg_0x8a550d0);
#line 59
...
# 40 "/opt/tinyos-1.x/tos/platform/pc/SpiByteFifo.nc"
inline static  result_t SpiByteFifoC$SpiByteFifo$dataReady(uint8_t arg_0x8bb0978){
#line 40
  unsigned char result;
#line 40

#line 40
  result = MicaHighSpeedRadioM$SpiByteFifo$dataReady(arg_0x8bb0978);
#line 40
...
inline static  result_t SecDedEncoding$Code$encodeDone(char arg_0x8bb6b20){
#line 38
  unsigned char result;
#line 38

#line 38
  result = MicaHighSpeedRadioM$Code$encodeDone(arg_0x8bb6b20);
#line 38
...
# 38 "/opt/tinyos-1.x/tos/interfaces/RadioCoordinator.nc"
inline static   void MicaHighSpeedRadioM$RadioSendCoordinator$byte(TOS_MsgPtr arg_0x8bbdd78, uint8_t arg_0x8bbdec8){
#line 38
  MicaHighSpeedRadioM$RadioSendCoordinator$default$byte(arg_0x8bbdd78, arg_0x8bbdec8);
#line 38
}
#line 38
static inline  
...
inline static   void MicaHighSpeedRadioM$RadioReceiveCoordinator$startSymbol(uint8_t arg_0x8bbd668, uint8_t arg_0x8bbd7b0, TOS_MsgPtr arg_0x8bbd900){
#line 33
  MicaHighSpeedRadioM$RadioReceiveCoordinator$default$startSymbol(arg_0x8bbd668, arg_0x8bbd7b0, arg_0x8bbd900);
#line 33
}
#line 33
static inline  
...
inline static  result_t MicaHighSpeedRadioM$SpiByteFifo$startReadBytes(uint16_t arg_0x8bb5d08){
#line 35
  unsigned char result;
#line 35

#line 35
  result = SpiByteFifoC$SpiByteFifo$startReadBytes(arg_0x8bb5d08);
#line 35
...
# 33 "/opt/tinyos-1.x/tos/interfaces/RadioCoordinator.nc"
inline static   void MicaHighSpeedRadioM$RadioSendCoordinator$startSymbol(uint8_t arg_0x8bbd668, uint8_t arg_0x8bbd7b0, TOS_MsgPtr arg_0x8bbd900){
#line 33
  MicaHighSpeedRadioM$RadioSendCoordinator$default$startSymbol(arg_0x8bbd668, arg_0x8bbd7b0, arg_0x8bbd900);
#line 33
}
#line 33
static inline   
...
#line 34
# 33 "/opt/tinyos-1.x/tos/platform/pc/SpiByteFifo.nc"
inline static  result_t MicaHighSpeedRadioM$SpiByteFifo$send(uint8_t arg_0x8bb5648){
#line 33
  unsigned char result;
#line 33

#line 33
  result = SpiByteFifoC$SpiByteFifo$send(arg_0x8bb5648);
#line 33
...
inline static  result_t MicaHighSpeedRadioM$Code$encode(char arg_0x8bb9db8){
#line 34
  unsigned char result;
#line 34

#line 34
  result = SecDedEncoding$Code$encode(arg_0x8bb9db8);
#line 34
...
# 67 "/opt/tinyos-1.x/tos/interfaces/BareSendMsg.nc"
inline static  result_t MicaHighSpeedRadioM$Send$sendDone(TOS_MsgPtr arg_0x898ba90, result_t arg_0x898bbe0){
#line 67
  unsigned char result;
#line 67

#line 67
  result = AMStandard$RadioSend$sendDone(arg_0x898ba90, arg_0x898bbe0);
#line 67
...
# 38 "/opt/tinyos-1.x/tos/interfaces/RadioCoordinator.nc"
inline static   void MicaHighSpeedRadioM$RadioReceiveCoordinator$byte(TOS_MsgPtr arg_0x8bbdd78, uint8_t arg_0x8bbdec8){
#line 38
  MicaHighSpeedRadioM$RadioReceiveCoordinator$default$byte(arg_0x8bbdd78, arg_0x8bbdec8);
#line 38
}
#line 38
static inline  
...
# 37 "/opt/tinyos-1.x/tos/platform/pc/RadioEncoding.nc"
inline static  result_t SecDedEncoding$Code$decodeDone(char arg_0x8bb65d8, char arg_0x8bb6718){
#line 37
  unsigned char result;
#line 37

#line 37
  result = MicaHighSpeedRadioM$Code$decodeDone(arg_0x8bb65d8, arg_0x8bb6718);
#line 37
...
inline static  result_t MicaHighSpeedRadioM$Code$decode(char arg_0x8bb61d8){
#line 35
  unsigned char result;
#line 35

#line 35
  result = SecDedEncoding$Code$decode(arg_0x8bb61d8);
#line 35
...
# 75 "/opt/tinyos-1.x/tos/interfaces/ReceiveMsg.nc"
inline static  TOS_MsgPtr CrcFilter$UpperReceive$receive(TOS_MsgPtr arg_0x898dda8){
#line 75
  struct TOS_Msg *result;
#line 75

#line 75
  result = AMStandard$RadioReceive$receive(arg_0x898dda8);
#line 75
...
# 75 "/opt/tinyos-1.x/tos/interfaces/ReceiveMsg.nc"
inline static  TOS_MsgPtr MicaHighSpeedRadioM$Receive$receive(TOS_MsgPtr arg_0x898dda8){
#line 75
  struct TOS_Msg *result;
#line 75

#line 75
  result = CrcFilter$LowerReceive$receive(arg_0x898dda8);
#line 75
...
# 67 "/opt/tinyos-1.x/tos/interfaces/BareSendMsg.nc"
inline static  result_t Nido$RadioSendMsg$sendDone(TOS_MsgPtr arg_0x898ba90, result_t arg_0x898bbe0){
#line 67
  unsigned char result;
#line 67

#line 67
  result = Nido$RadioSendMsg$default$sendDone(arg_0x898ba90, arg_0x898bbe0);
#line 67
...
# 75 "/opt/tinyos-1.x/tos/interfaces/ReceiveMsg.nc"
inline static  TOS_MsgPtr Nido$RadioReceiveMsg$receive(TOS_MsgPtr arg_0x898dda8){
#line 75
  struct TOS_Msg *result;
#line 75
...
result_t SarpM$StdControl$init(void)
{
  ...
  SarpM$myStaticParent[tos_state.current_node].node_id = 255;
  SarpM$myStaticParent[tos_state.current_node].level = 255;
  SarpM$myStaticParent[tos_state.current_node].parent_id = 255;
  ...
  if (SarpM$myAddr[tos_state.current_node] == 0) 
    ...
    {
      SarpM$myLevel[tos_state.current_node] = 255;
    }
...
inline static   result_t TimerM$Clock$setRate(char arg_0x8a40cb8, char arg_0x8a40df8){
#line 96
  unsigned char result;
#line 96

#line 96
  result = HPLClock$Clock$setRate(arg_0x8a40cb8, arg_0x8a40df8);
#line 96
...
#line 70
# 59 "/opt/tinyos-1.x/tos/interfaces/Timer.nc"
inline static  result_t AMStandard$ActivityTimer$start(char arg_0x8a54f78, uint32_t arg_0x8a550d0){
#line 59
  unsigned char result;
#line 59

#line 59
  result = TimerM$Timer$start(11, arg_0x8a54f78, arg_0x8a550d0);
#line 59
  result = rcombine(result, TimerM$Timer$start(10, arg_0x8a54f78, arg_0x8a550d0));
#line 59
...
inline static   result_t Nido$PowerState$init(int arg_0x8988a80, int arg_0x8988bc8){
#line 14
  unsigned char result;
#line 14

#line 14
  result = PowerStateM$PowerState$init(arg_0x8988a80, arg_0x8988bc8);
#line 14
...
# 75 "/opt/tinyos-1.x/tos/interfaces/ReceiveMsg.nc"
inline static  TOS_MsgPtr Nido$UARTReceiveMsg$receive(TOS_MsgPtr arg_0x898dda8){
#line 75
  struct TOS_Msg *result;
#line 75

#line 75
  result = AMStandard$UARTReceive$receive(arg_0x898dda8);
#line 75
  result = AMStandard$UARTReceive$receive(arg_0x898dda8);
#line 75
      ...
      if (neighborFound == 0) 
        {
          ...
          neighbors[*numNeighbors].trust.trustFP = 1.0;
          neighbors[*numNeighbors].trust.GFB = 100.0;
          neighbors[*numNeighbors].trust.BFB = 0.0;
          neighbors[*numNeighbors].trust.trustRH = 1.0;
          neighbors[*numNeighbors].trust.GRB = 100.0;
          neighbors[*numNeighbors].trust.BRB = 0.0;
          neighbors[*numNeighbors].trust.trustAV = 1.0;
          neighbors[*numNeighbors].trust.GAB = 100.0;
          neighbors[*numNeighbors].trust.BAB = 0.0;
          neighbors[*numNeighbors].trust.trustLP = 1.0;
          neighbors[*numNeighbors].trust.GLB = 100.0;
          neighbors[*numNeighbors].trust.BLB = 0.0;
          neighbors[*numNeighbors].trust.trustPR = 1.0;
          neighbors[*numNeighbors].trust.GPB = 100.0;
          neighbors[*numNeighbors].trust.BPB = 0.0;
          neighbors[*numNeighbors].trust.overallTrust = 1.0;
#line 135
          if (*isOneHop == 1) 
            {
...
static  
# 234 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/MessagingM.nc"
void MessagingM$Messaging$putNeighborDiscoveryControlMsgInOutQ(TOS_Msg outQ[], uint16_t *writeHere, uint16_t maxQSize, uint16_t *numMsgOutQ, uint16_t whoIAm, uint16_t whoIHeard, uint16_t parent)
{
...
static  
# 212 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/MessagingM.nc"
void MessagingM$Messaging$putStartMsgInOutQ(TOS_Msg outQ[], uint16_t *writeHere, uint16_t maxQSize, uint16_t *numMsgOutQ, uint16_t sender)
{
...
#line 119
          ...
          transactionRecords[tLoopCounter].oneHopReportedPacketsForwardedTo = 255;
...
static  
# 184 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/TransactionTableM.nc"
uint16_t TransactionTableM$TransactionTable$getTransactionParent(Transaction_Record_t transactions[], uint32_t transaction_id)
{
  for (tLoopCounter = 0; tLoopCounter < CIRCULAR_BUFFER_SIZE; tLoopCounter++) 
    {
...
static  
# 570 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/TransactionTableM.nc"
void TransactionTableM$TransactionTable$addToTransactionCheckQ(Check_Transaction_Record_t queue[], Transaction_Record_Ptr ptr, uint16_t ones, uint16_t twos, uint16_t *writeHere, uint16_t maxQueueSize, uint16_t *numInQueue)
{
...
static  
# 149 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/MessagingM.nc"
void MessagingM$Messaging$putReportResponseNoForwardMsgInOutQ(TOS_Msg outQ[], uint16_t *writeHere, uint16_t maxQSize, uint16_t *numMsgOutQ, uint16_t responder, uint32_t transaction_id, uint16_t packetsReceived, uint16_t packetsReceivedFrom, uint16_t packetsForwarded, uint16_t packetsForwardedTo, uint16_t originatingNode)
{
...
static  
# 293 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/TransactionTableM.nc"
void TransactionTableM$TransactionTable$adjustThisNeighborsOverallTrust(Neighbor_Rec_withTrust_t neighbors[], uint16_t node_id, uint16_t numNeighbors, uint16_t whoIAm, uint32_t transactionNumber, uint32_t GFBinc, uint32_t BFBinc, uint32_t GRBinc, uint32_t BRBinc, uint32_t GABinc, uint32_t BABinc, uint32_t GLBinc, uint32_t BLBinc)
{

  dbg(DBG_USR3, "node_id:%d numNeighbors:%d whoIAm:%d GFBinc:%d BFBinc:%d GRBinc:%d BRBinc:%d GABinc:%d BABinc:%d GLBinc:%d BLBinc:%d\n", node_id, numNeighbors, whoIAm, GFBinc, BFBinc, GRBinc, BRBinc, GABinc, BABinc, GLBinc, BLBinc);
      ...
      if (neighbors[tnLoopCounter].node_id == node_id) 
        {
          ...
          dbg(DBG_USR3, "OVERALLTRUST START\n");
          dbg(DBG_USR3, "[%d] GFB:%d BFB:%d trustFP:%f\n", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.GFB, neighbors[tnLoopCounter].trust.BFB, neighbors[tnLoopCounter].trust.trustFP);
          dbg(DBG_USR3, "[%d] GRB:%d BRB:%d trustRH:%f\n", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.GRB, neighbors[tnLoopCounter].trust.BRB, neighbors[tnLoopCounter].trust.trustRH);
          dbg(DBG_USR3, "[%d] GAB:%d BAB:%d trustAV:%f\n", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.GAB, neighbors[tnLoopCounter].trust.BAB, neighbors[tnLoopCounter].trust.trustAV);
          dbg(DBG_USR3, "[%d] GLB:%d BLB:%d trustLP:%f\n", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.GLB, neighbors[tnLoopCounter].trust.BLB, neighbors[tnLoopCounter].trust.trustLP);
          dbg(DBG_USR3, "[%d] GPB:%d BPB:%d trustPR:%f\n", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.GPB, neighbors[tnLoopCounter].trust.BPB, neighbors[tnLoopCounter].trust.trustPR);
          dbg(DBG_USR3, "[%d] overallTrust:%f\n", neighbors[tnLoopCounter].node_id, neighbors[tnLoopCounter].trust.overallTrust);
          dbg(DBG_USR3, "OVERALLTRUST FINISH\n");
...
static  
# 184 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/MessagingM.nc"
void MessagingM$Messaging$putEndToEndReportResponseMsgInOutQ(TOS_Msg outQ[], uint16_t *writeHere, uint16_t maxQSize, uint16_t *numMsgOutQ, uint16_t responder, uint16_t originator, uint32_t transaction_id, uint16_t packetsReceived, uint16_t packetsReceivedFrom, uint16_t packetsSent)
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
    {
...
static  
# 121 "/opt/tinyos-1.x/apps/sarp-0.3-dev/modules/MessagingM.nc"
void MessagingM$Messaging$putSpecificReportResponseMsgInOutQ(TOS_Msg outQ[], uint16_t *writeHere, uint16_t maxQSize, uint16_t *numMsgOutQ, uint16_t responder, uint16_t originator, uint32_t transaction_id, uint16_t packetsReceived, uint16_t packetsReceivedFrom, uint16_t packetsForwarded, uint16_t packetsForwardedTo, uint16_t transactionParent)
{
