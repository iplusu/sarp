/*$T indentinput.h GC 1.140 06/02/10 17:23:11 */

/* File: TrafficGeneratorH.h Author: Kenneth Rahn Jr Created: May 20, 2009 */
#ifndef ATTACK_H
#define ATTACK_H

/*
 * BEGIN SELECTIVE FORWARDING PARAMETERS ;
 * Example SF setup Let's say we want node 22 to selectively forward 50% of node
 * 23's packets and node 17 to selectively forward 60% of node 22's packets.
...
uint16_t		selectiveForwardAttackers[] = { 1, 3 };
uint16_t		selectiveForwardVictims[] = { 4, 4 };
uint16_t		selectiveForwardNumerators[] = { 1, 7 };
uint16_t		selectiveForwardDenomenators[] = { 10, 10 };
