...
implementation {
  ...
  command result_t NeighborTable.processNeighborFromDiscMsg(Neighbor_Rec_withTrust_t neighbors[], Neighbor_Rec_withTrust_t *myOneHopNeighbors[], uint16_t *numNeighbors, uint16_t *numOneHopNeighbors, uint16_t nodeId_l, uint8_t level_l, uint16_t parent_l, uint16_t *isOneHop)
  {
    atomic
    {
      ...
      if (neighborFound == 0)
      {
        ...
        neighbors[*numNeighbors].trust.GPB = TRUST_GPB_START;
        neighbors[*numNeighbors].trust.BPB = TRUST_BPB_START;
        neighbors[*numNeighbors].trust.overallTrust = TRUST_OV_START;
		//#define DEBUG1
		#ifdef DEBUG1
		dbg(DBG_USR3, "%d: %d, %d, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f\n",nodeId_l,level_l,parent_l,TRUST_FP_START,TRUST_GFB_START,TRUST_BFB_START,TRUST_RH_START,TRUST_GRB_START,\
		TRUST_BRB_START,TRUST_AV_START,TRUST_GAB_START,TRUST_BAB_START,TRUST_LP_START,TRUST_GLB_START,TRUST_BLB_START,TRUST_OV_START);
		dbg(DBG_USR3, "%d: %d, %d, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f\n",neighbors[*numNeighbors].node_id,neighbors[*numNeighbors].level,neighbors[*numNeighbors].parent_id,\
        neighbors[*numNeighbors].trust.trustFP,neighbors[*numNeighbors].trust.GFB,neighbors[*numNeighbors].trust.BFB,neighbors[*numNeighbors].trust.trustRH,\
        neighbors[*numNeighbors].trust.GRB,neighbors[*numNeighbors].trust.BRB,neighbors[*numNeighbors].trust.trustAV,neighbors[*numNeighbors].trust.GAB,neighbors[*numNeighbors].trust.BAB,\
        neighbors[*numNeighbors].trust.trustLP,neighbors[*numNeighbors].trust.GLB,neighbors[*numNeighbors].trust.BLB,neighbors[*numNeighbors].trust.overallTrust);
		#endif
  ...
  command uint16_t NeighborTable.getNewTransactionParent(Neighbor_Rec_withTrust_t *myOneHopNeighbors[], uint16_t numOneHopNeighbors, uint8_t myLevel_l, Neighbor_Rec_withTrust_t *myPeers[], uint16_t numPeers, Neighbor_Rec_withTrust_t *myChildren[], uint16_t numChildren, uint16_t dontPickMe, uint16_t dontPickMeEither, uint16_t reallyDontPickMe, uint16_t whoIAm)
  {
	...
	sendSarpParent(TOS_LOCAL_ADDRESS, myOneHopNeighbors[chosenParentTrustIndex]->node_id);
    #endif
