...
implementation {
  ...
  {
  #ifdef DEBUG3
  dbg(DBG_USR3, "putSpecificReportResponseMsgInOutQ // packetsReceivedFrom:%d packetsReceived:%d",putReportResponseNoForwardMsgInOutQ,packetsReceived);
  #endif
    atomic
    {
  ...
  {
  #ifdef DEBUG3
  dbg(DBG_USR3, "putReportResponseNoForwardMsgInOutQ // packetsReceivedFrom:%d packetsReceived:%d",putReportResponseNoForwardMsgInOutQ,packetsReceived);
  #endif
    atomic
    {
