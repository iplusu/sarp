...
uint16_t selectiveForwardAttackers[]    = { 6, 6, 10 };
uint16_t selectiveForwardVictims[]      = { 11, 11, 11 };
uint16_t selectiveForwardNumerators[]   = { 1, 1, 8 };
uint16_t selectiveForwardDenomenators[] = { 10, 10, 10};

uint16_t numSFAttackers                 = 3;
