...
uint16_t selectiveForwardAttackers[]    = { 2, 2, 4, 4, 4, 4 };
uint16_t selectiveForwardVictims[]      = { 5, 1, 1, 3, 7, 5 };
uint16_t selectiveForwardNumerators[]   = { 1, 1, 7, 7, 7, 7 };
